...
def api_users_activities_retrieve(id: int, api_config_override: Optional[APIConfig] = None) -> UserActivity:
    api_config = api_config_override if api_config_override else APIConfig()
...
def api_users_users_activities_list_2(
    user_id: int,
    ordering: Optional[str] = None,
    page: Optional[int] = None,
    search: Optional[str] = None,
...
def api_users_users_activities_retrieve(
