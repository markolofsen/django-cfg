...
async def api_users_users_list(
...
async def api_users_users_create(
    data: UserCreateRequest, api_config_override: Optional[APIConfig] = None
) -> UserCreate:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_users_users_retrieve(id: int, api_config_override: Optional[APIConfig] = None) -> UserDetail:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_users_users_update(
...
async def api_users_users_destroy(id: int, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_users_users_partial_update(
...
async def api_users_users_activate_create(
...
async def api_users_users_activities_list(
    id: int,
    ordering: Optional[str] = None,
    page: Optional[int] = None,
    search: Optional[str] = None,
...
async def api_users_users_deactivate_create(
    id: int, data: UserDetailRequest, api_config_override: Optional[APIConfig] = None
) -> UserDetail:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_users_users_profile_retrieve(id: int, api_config_override: Optional[APIConfig] = None) -> UserProfile:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_users_users_profile_update(
    id: int, data: UserDetailRequest, api_config_override: Optional[APIConfig] = None
) -> UserProfile:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_users_users_profile_partial_update(
...
async def api_users_users_stats_retrieve(api_config_override: Optional[APIConfig] = None) -> UserStats:
    api_config = api_config_override if api_config_override else APIConfig()
