...
async def api_newsletter_campaigns_list(
...
async def api_newsletter_campaigns_create(
...
async def api_newsletter_campaigns_retrieve(
...
async def api_newsletter_campaigns_update(
...
async def api_newsletter_campaigns_destroy(id: int, api_config_override: Optional[APIConfig] = None) -> Dict[str, Any]:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_newsletter_campaigns_send_create(
