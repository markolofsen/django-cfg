...
async def api_support_tickets_list(
...
async def api_support_tickets_create(data: TicketRequest, api_config_override: Optional[APIConfig] = None) -> Ticket:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_support_tickets_messages_list(
    ticket_uuid: str,
...
async def api_support_tickets_messages_create(
...
async def api_support_tickets_messages_retrieve(
...
async def api_support_tickets_messages_update(
...
async def api_support_tickets_messages_destroy(
    ticket_uuid: str, uuid: str, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_support_tickets_messages_partial_update(
...
async def api_support_tickets_retrieve(uuid: str, api_config_override: Optional[APIConfig] = None) -> Ticket:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_support_tickets_update(
...
async def api_support_tickets_destroy(uuid: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_support_tickets_partial_update(
