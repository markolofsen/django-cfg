...
def api_shop_products_retrieve(slug: str, api_config_override: Optional[APIConfig] = None) -> ProductDetail:
    api_config = api_config_override if api_config_override else APIConfig()
...
def api_shop_products_featured_retrieve(api_config_override: Optional[APIConfig] = None) -> ProductDetail:
    api_config = api_config_override if api_config_override else APIConfig()
...
def api_shop_products_stats_retrieve(api_config_override: Optional[APIConfig] = None) -> ShopStats:
    api_config = api_config_override if api_config_override else APIConfig()
