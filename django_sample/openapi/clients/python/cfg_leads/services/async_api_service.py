...
async def api_leads_leads_list(
...
async def api_leads_leads_create(
...
async def api_leads_leads_retrieve(id: int, api_config_override: Optional[APIConfig] = None) -> LeadSubmission:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_leads_leads_update(
...
async def api_leads_leads_destroy(id: int, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_leads_leads_partial_update(
