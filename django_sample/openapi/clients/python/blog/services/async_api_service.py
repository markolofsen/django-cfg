...
async def api_blog_categories_partial_update(
...
async def api_blog_comments_partial_update(
...
async def api_blog_posts_comments_partial_update(
...
async def api_blog_posts_partial_update(
...
async def api_blog_tags_retrieve(slug: str, api_config_override: Optional[APIConfig] = None) -> Tag:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_tags_update(slug: str, data: TagRequest, api_config_override: Optional[APIConfig] = None) -> Tag:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_tags_destroy(slug: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_tags_partial_update(
