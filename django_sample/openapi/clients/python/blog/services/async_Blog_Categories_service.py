...
async def api_blog_categories_list(
...
async def api_blog_categories_create(
    data: CategoryRequest, api_config_override: Optional[APIConfig] = None
) -> Category:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_categories_retrieve(slug: str, api_config_override: Optional[APIConfig] = None) -> Category:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_categories_update(
    slug: str, data: CategoryRequest, api_config_override: Optional[APIConfig] = None
) -> Category:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_categories_destroy(slug: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
