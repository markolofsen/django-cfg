...
async def api_blog_comments_list(
...
async def api_blog_comments_create(data: CommentRequest, api_config_override: Optional[APIConfig] = None) -> Comment:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_comments_retrieve(id: int, api_config_override: Optional[APIConfig] = None) -> Comment:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_comments_update(
    id: int, data: CommentRequest, api_config_override: Optional[APIConfig] = None
) -> Comment:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_comments_destroy(id: int, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def api_blog_posts_comments_list(
    post_slug: str,
    author: Optional[int] = None,
    is_approved: Optional[bool] = None,
    ordering: Optional[str] = None,
...
async def api_blog_posts_comments_create(
...
async def api_blog_posts_comments_retrieve(
...
async def api_blog_posts_comments_update(
...
async def api_blog_posts_comments_destroy(
    id: int, post_slug: str, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
