...
import { TerminalTerminal } from "./terminal__api__terminal/client";
export * as TerminalTerminalTypes from "./terminal__api__terminal/models";
...
export class API {
  ...
  // Sub-clients
  public terminal_terminal!: TerminalTerminal;
  ...
  constructor(baseUrl: string, options?: APIOptions) {
    ...
    this.terminal_terminal = this._client.terminal_terminal;
  }
