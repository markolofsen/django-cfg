...
# Note: These will be generated after running: python manage.py generate_proto
try:
    from apps.crypto.grpc_services.generated import crypto_service_pb2
except ImportError:
    # Fallback during initial setup
    crypto_service_pb2 = None
