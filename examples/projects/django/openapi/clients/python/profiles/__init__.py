...
from .profiles__api__profiles import ProfilesProfilesAPI
...
class API:
    ...
    @property
    def profiles_profiles(self) -> ProfilesProfilesAPI:
        """Access Profiles endpoints."""
        return self._client.profiles_profiles
