...
class TradingTradingAPI:
    ...
    async def orders_list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedOrderList]:
        """
        List orders
    ...
    async def orders_create(self, data: OrderCreateRequest) -> OrderCreate:
        """
        Create order
    ...
    async def orders_retrieve(self, id: int) -> Order:
        """
        Get order
    ...
    async def orders_update(self, id: int, data: OrderRequest) -> Order:
        """
        ViewSet for trading orders.
        """
        url = f"/api/trading/orders/{id}/"
    ...
    async def orders_partial_update(self, id: int, data: PatchedOrderRequest | None = None) -> Order:
        """
        ViewSet for trading orders.
        """
        url = f"/api/trading/orders/{id}/"
    ...
    async def orders_destroy(self, id: int) -> None:
        """
        ViewSet for trading orders.
        """
        url = f"/api/trading/orders/{id}/"
    ...
    async def portfolios_list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedPortfolioList]:
        """
        List portfolios
    ...
    async def portfolios_retrieve(self, id: int) -> Portfolio:
        """
        Get portfolio
    ...
    async def portfolios_me_retrieve(self) -> Portfolio:
        """
        Get my portfolio
    ...
    async def portfolios_stats_retrieve(self) -> PortfolioStats:
        """
