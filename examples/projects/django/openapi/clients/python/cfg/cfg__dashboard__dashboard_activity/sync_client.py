...
class SyncCfgDashboardActivityAPI:
    """Synchronous API endpoints for Dashboard - Activity."""

    def __init__(self, client: httpx.Client):
        """Initialize sync sub-client with shared httpx client."""
        self._client = client

    def dashboard_api_activity_actions_list(self) -> None:
        """
        Get quick actions
    ...
    def dashboard_api_activity_recent_list(self, limit: int | None = None) -> None:
        """
        Get recent activity
