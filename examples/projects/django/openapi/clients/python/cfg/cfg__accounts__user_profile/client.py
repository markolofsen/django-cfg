...
class CfgUserProfileAPI:
    ...
    async def accounts_profile_avatar_create(self, data: InlineRequestBody) -> User:
        """
        Upload user avatar
    ...
    async def accounts_profile_partial_partial_update(self, data: PatchedUserProfileUpdateRequest | None = None) -> User:
        """
        Partial update user profile
    ...
    async def accounts_profile_update_partial_update(self, data: PatchedUserProfileUpdateRequest | None = None) -> User:
        """
        Update user profile
