...
class SyncCfgCentrifugoMonitoringAPI:
    ...
    def centrifugo_admin_api_monitor_health_retrieve(self) -> HealthCheck:
        """
    ...
    def centrifugo_admin_api_monitor_overview_retrieve(self, hours: int | None = None) -> OverviewStats:
        """
    ...
    def centrifugo_admin_api_monitor_publishes_retrieve(self, channel: str | None = None, count: int | None = None, offset: int | None = None, status: str | None = None) -> RecentPublishes:
        """
    ...
    def centrifugo_admin_api_monitor_timeline_retrieve(self, hours: int | None = None, interval: str | None = None) -> list[ChannelList]:
        """
