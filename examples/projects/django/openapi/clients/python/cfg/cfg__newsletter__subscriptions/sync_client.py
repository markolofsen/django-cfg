...
class SyncCfgSubscriptionsAPI:
    ...
    def newsletter_subscribe_create(self, data: SubscribeRequest) -> SubscribeResponse:
        """
    ...
    def newsletter_subscriptions_list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedNewsletterSubscriptionList]:
        """
