...
class SyncCfgCentrifugoTestingAPI:
    ...
    def centrifugo_admin_api_testing_connection_token_create(self, data: ConnectionTokenRequestRequest) -> ConnectionTokenResponse:
        """
    ...
    def centrifugo_admin_api_testing_publish_test_create(self, data: PublishTestRequestRequest) -> PublishTestResponse:
        """
    ...
    def centrifugo_admin_api_testing_publish_with_logging_create(self, data: PublishTestRequestRequest) -> PublishTestResponse:
        """
    ...
    def centrifugo_admin_api_testing_send_ack_create(self, data: ManualAckRequestRequest) -> ManualAckResponse:
        """
        Send manual ACK
