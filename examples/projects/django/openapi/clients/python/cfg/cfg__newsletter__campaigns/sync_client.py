...
class SyncCfgCampaignsAPI:
    ...
    def newsletter_campaigns_list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedNewsletterCampaignList]:
        """
    ...
    def newsletter_campaigns_create(self, data: NewsletterCampaignRequest) -> NewsletterCampaign:
        """
    ...
    def newsletter_campaigns_retrieve(self, id: int) -> NewsletterCampaign:
        """
    ...
    def newsletter_campaigns_update(self, id: int, data: NewsletterCampaignRequest) -> NewsletterCampaign:
        """
        Update Campaign
    ...
    def newsletter_campaigns_destroy(self, id: int) -> None:
        """
        Delete Campaign
    ...
    def newsletter_campaigns_send_create(self, data: SendCampaignRequest) -> SendCampaignResponse:
        """
