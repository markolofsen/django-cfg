 ...
 */
export function isPublicRoute(routes: UnrealonRoutes, path: string): boolean {
 ...
 */
export function isAuthRoute(routes: UnrealonRoutes, path: string): boolean {
 ...
 */
export function getUnauthenticatedRedirect(routes: UnrealonRoutes, path: string): string | null {
 ...
 */
export function redirectToAuth(routes: UnrealonRoutes): string {
  return routes.public.auth;
}
