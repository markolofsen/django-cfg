...
class RPCClientConfig:
    ...
    ENDPOINTS = {
        "development": "ws://localhost:8765/ws",
        "production": "wss://ws.unrealon.com/ws",
        "staging": "wss://ws-staging.unrealon.com/ws",
    }
...
class RPCClient:
    ...
    async def workspace_file_changed(self, params: Any) -> Any:
        """Call workspace.file_changed RPC method
        ...
        Returns:
            Any
        """
        result = await self._call('workspace.file_changed', params)
        return Any(**result)

    async def workspace_snapshot_created(self, params: Any) -> Any:
        """Call workspace.snapshot_created RPC method
        ...
        Returns:
            Any
        """
        result = await self._call('workspace.snapshot_created', params)
        return Any(**result)

    async def workspace_state_changed(self, params: Any) -> Any:
        """Call workspace.state_changed RPC method
        ...
        Returns:
            Any
        """
        result = await self._call('workspace.state_changed', params)
        return Any(**result)

    async def session_message(self, params: Any) -> Any:
        """Call session.message RPC method
        ...
        Returns:
            Any
        """
        result = await self._call('session.message', params)
        return Any(**result)

    async def session_task_status(self, params: Any) -> Any:
        """Call session.task_status RPC method
        ...
        Returns:
            Any
        """
        result = await self._call('session.task_status', params)
        return Any(**result)

    async def session_context_updated(self, params: Any) -> Any:
        """Call session.context_updated RPC method
        ...
        Returns:
            Any
        """
        result = await self._call('session.context_updated', params)
        return Any(**result)

    async def notification_send(self, params: Any) -> Any:
        """Call notification.send RPC method
        ...
        Returns:
            Any
        """
        result = await self._call('notification.send', params)
        return Any(**result)

    async def notification_broadcast(self, params: Any) -> Any:
        """Call notification.broadcast RPC method
        ...
        Returns:
            Any
        """
        result = await self._call('notification.broadcast', params)
        return Any(**result)
