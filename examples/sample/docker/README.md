# 🐳 ReformsAI Django - Docker Infrastructure

This directory contains modular Docker configuration for the ReformsAI Django CFG Sample Project.
...
| `DJANGO_SUPERUSER_EMAIL` | `admin@reforms.ai` | Admin email |
