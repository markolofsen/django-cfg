...
T = TypeVar("T", bound="PaginatedNewsletterSubscriptionList")


@_attrs_define
class PaginatedNewsletterSubscriptionList:
    """
    Attributes:
        ...
        results (list['NewsletterSubscription']): Array of items for current page
    ...
    has_next: bool
    has_previous: bool
    results: list["NewsletterSubscription"]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = NewsletterSubscription.from_dict(results_item_data)
        ...
        paginated_newsletter_subscription_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_newsletter_subscription_list.additional_properties = d
        return paginated_newsletter_subscription_list
