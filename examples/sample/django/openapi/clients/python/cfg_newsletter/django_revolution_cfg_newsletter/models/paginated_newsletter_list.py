...
T = TypeVar("T", bound="PaginatedNewsletterList")


@_attrs_define
class PaginatedNewsletterList:
    """
    Attributes:
        ...
        results (list['Newsletter']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Newsletter.from_dict(results_item_data)
        ...
        paginated_newsletter_list.additional_properties = d
        return paginated_newsletter_list
