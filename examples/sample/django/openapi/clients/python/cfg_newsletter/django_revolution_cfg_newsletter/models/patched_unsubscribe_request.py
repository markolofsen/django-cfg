...
T = TypeVar("T", bound="PatchedUnsubscribeRequest")


@_attrs_define
class PatchedUnsubscribeRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_unsubscribe_request = cls(
            subscription_id=subscription_id,
        )

        patched_unsubscribe_request.additional_properties = d
        return patched_unsubscribe_request
