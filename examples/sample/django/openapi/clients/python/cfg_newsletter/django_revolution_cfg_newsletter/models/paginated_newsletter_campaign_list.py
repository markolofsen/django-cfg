...
T = TypeVar("T", bound="PaginatedNewsletterCampaignList")


@_attrs_define
class PaginatedNewsletterCampaignList:
    """
    Attributes:
        ...
        results (list['NewsletterCampaign']): Array of items for current page
    ...
    has_next: bool
    has_previous: bool
    results: list["NewsletterCampaign"]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = NewsletterCampaign.from_dict(results_item_data)
        ...
        paginated_newsletter_campaign_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_newsletter_campaign_list.additional_properties = d
        return paginated_newsletter_campaign_list
