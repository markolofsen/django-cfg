...
T = TypeVar("T", bound="PatchedUserProfileUpdateRequest")


@_attrs_define
class PatchedUserProfileUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_user_profile_update_request = cls(
        ...
        patched_user_profile_update_request.additional_properties = d
        return patched_user_profile_update_request
