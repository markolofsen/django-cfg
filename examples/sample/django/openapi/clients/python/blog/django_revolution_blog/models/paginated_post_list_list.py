...
T = TypeVar("T", bound="PaginatedPostListList")


@_attrs_define
class PaginatedPostListList:
    """
    Attributes:
        ...
        results (list['PostList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PostList.from_dict(results_item_data)
        ...
        paginated_post_list_list.additional_properties = d
        return paginated_post_list_list
