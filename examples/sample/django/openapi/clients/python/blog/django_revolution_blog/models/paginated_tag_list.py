...
T = TypeVar("T", bound="PaginatedTagList")
...
class PaginatedTagList:
    ...
    Attributes:
        ...
        results (list['Tag']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_tag_list.additional_properties = d
        return paginated_tag_list
