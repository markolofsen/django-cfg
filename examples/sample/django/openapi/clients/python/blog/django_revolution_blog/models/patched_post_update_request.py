...
from ..models.patched_post_update_request_status import check_patched_post_update_request_status
from ..models.patched_post_update_request_status import PatchedPostUpdateRequestStatus
...
T = TypeVar("T", bound="PatchedPostUpdateRequest")


@_attrs_define
class PatchedPostUpdateRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, PatchedPostUpdateRequestStatus]): * `draft` - Draft
            * `published` - Published
            * `archived` - Archived
    ...
    status: Union[Unset, PatchedPostUpdateRequestStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, PatchedPostUpdateRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = check_patched_post_update_request_status(_status)
        ...
        patched_post_update_request = cls(
            title=title,
            content=content,
            excerpt=excerpt,
            category=category,
        ...
        patched_post_update_request.additional_properties = d
        return patched_post_update_request
