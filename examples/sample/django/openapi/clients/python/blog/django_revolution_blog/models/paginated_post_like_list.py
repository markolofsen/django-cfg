...
T = TypeVar("T", bound="PaginatedPostLikeList")


@_attrs_define
class PaginatedPostLikeList:
    """
    Attributes:
        ...
        results (list['PostLike']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PostLike.from_dict(results_item_data)
        ...
        paginated_post_like_list.additional_properties = d
        return paginated_post_like_list
