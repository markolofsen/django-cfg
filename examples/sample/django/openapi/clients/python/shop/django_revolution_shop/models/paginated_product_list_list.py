...
T = TypeVar("T", bound="PaginatedProductListList")


@_attrs_define
class PaginatedProductListList:
    """
    Attributes:
        ...
        results (list['ProductList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ProductList.from_dict(results_item_data)
        ...
        paginated_product_list_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_product_list_list.additional_properties = d
        return paginated_product_list_list
