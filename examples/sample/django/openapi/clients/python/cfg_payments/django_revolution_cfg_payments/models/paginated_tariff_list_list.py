...
if TYPE_CHECKING:
    from ..models.tariff_list import TariffList


T = TypeVar("T", bound="PaginatedTariffListList")


@_attrs_define
class PaginatedTariffListList:
    """
    Attributes:
        ...
        results (list['TariffList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TariffList.from_dict(results_item_data)
        ...
        paginated_tariff_list_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_tariff_list_list.additional_properties = d
        return paginated_tariff_list_list
