...
if TYPE_CHECKING:
    from ..models.currency_network import CurrencyNetwork


T = TypeVar("T", bound="PaginatedCurrencyNetworkList")


@_attrs_define
class PaginatedCurrencyNetworkList:
    """
    Attributes:
        ...
        results (list['CurrencyNetwork']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CurrencyNetwork.from_dict(results_item_data)
        ...
        paginated_currency_network_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_currency_network_list.additional_properties = d
        return paginated_currency_network_list
