...
T = TypeVar("T", bound="PaginatedAPIKeyListList")


@_attrs_define
class PaginatedAPIKeyListList:
    """
    Attributes:
        ...
        results (list['APIKeyList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = APIKeyList.from_dict(results_item_data)
        ...
        paginated_api_key_list_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_api_key_list_list.additional_properties = d
        return paginated_api_key_list_list
