...
T = TypeVar("T", bound="PaginatedUserBalanceList")


@_attrs_define
class PaginatedUserBalanceList:
    """
    Attributes:
        ...
        results (list['UserBalance']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = UserBalance.from_dict(results_item_data)
        ...
        paginated_user_balance_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_user_balance_list.additional_properties = d
        return paginated_user_balance_list
