...
T = TypeVar("T", bound="PaginatedCurrencyListList")


@_attrs_define
class PaginatedCurrencyListList:
    """
    Attributes:
        ...
        results (list['CurrencyList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CurrencyList.from_dict(results_item_data)
        ...
        paginated_currency_list_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_currency_list_list.additional_properties = d
        return paginated_currency_list_list
