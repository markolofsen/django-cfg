...
if TYPE_CHECKING:
    from ..models.endpoint_group import EndpointGroup


T = TypeVar("T", bound="PaginatedEndpointGroupList")


@_attrs_define
class PaginatedEndpointGroupList:
    """
    Attributes:
        ...
        results (list['EndpointGroup']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = EndpointGroup.from_dict(results_item_data)
        ...
        paginated_endpoint_group_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_endpoint_group_list.additional_properties = d
        return paginated_endpoint_group_list
