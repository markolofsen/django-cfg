...
from ..models.lead_submission_request_contact_type import check_lead_submission_request_contact_type
from ..models.lead_submission_request_contact_type import LeadSubmissionRequestContactType
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="LeadSubmissionRequest")
...
class LeadSubmissionRequest:
    ...
    Attributes:
        ...
        contact_type (Union[Unset, LeadSubmissionRequestContactType]): * `email` - Email
            * `whatsapp` - WhatsApp
            * `telegram` - Telegram
            * `phone` - Phone
            * `other` - Other
    ...
    contact_type: Union[Unset, LeadSubmissionRequestContactType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_type: Union[Unset, LeadSubmissionRequestContactType]
        if isinstance(_contact_type, Unset):
            contact_type = UNSET
        else:
            contact_type = check_lead_submission_request_contact_type(_contact_type)
        ...
        lead_submission_request.additional_properties = d
        return lead_submission_request
