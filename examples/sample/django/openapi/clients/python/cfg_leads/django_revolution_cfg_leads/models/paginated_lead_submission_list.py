...
T = TypeVar("T", bound="PaginatedLeadSubmissionList")


@_attrs_define
class PaginatedLeadSubmissionList:
    """
    Attributes:
        ...
        results (list['LeadSubmission']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = LeadSubmission.from_dict(results_item_data)
        ...
        paginated_lead_submission_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_lead_submission_list.additional_properties = d
        return paginated_lead_submission_list
