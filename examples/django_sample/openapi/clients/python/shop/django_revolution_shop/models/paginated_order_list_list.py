...
T = TypeVar("T", bound="PaginatedOrderListList")


@_attrs_define
class PaginatedOrderListList:
    """
    Attributes:
        ...
        results (list['OrderList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = OrderList.from_dict(results_item_data)
        ...
        paginated_order_list_list.additional_properties = d
        return paginated_order_list_list
