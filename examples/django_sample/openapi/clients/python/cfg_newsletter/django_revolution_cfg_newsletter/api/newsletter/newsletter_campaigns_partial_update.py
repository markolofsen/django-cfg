...
from ...models.patched_newsletter_campaign_request import PatchedNewsletterCampaignRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedNewsletterCampaignRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedNewsletterCampaignRequest): Serializer for NewsletterCampaign model.
        body (PatchedNewsletterCampaignRequest): Serializer for NewsletterCampaign model.
        body (PatchedNewsletterCampaignRequest): Serializer for NewsletterCampaign model.
