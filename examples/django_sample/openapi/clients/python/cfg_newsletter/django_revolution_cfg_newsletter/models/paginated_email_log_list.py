...
T = TypeVar("T", bound="PaginatedEmailLogList")


@_attrs_define
class PaginatedEmailLogList:
    """
    Attributes:
        ...
        results (list['EmailLog']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = EmailLog.from_dict(results_item_data)
        ...
        paginated_email_log_list.additional_properties = d
        return paginated_email_log_list
