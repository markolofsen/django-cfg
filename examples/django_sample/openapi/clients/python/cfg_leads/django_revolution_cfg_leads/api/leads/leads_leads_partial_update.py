...
from ...models.patched_lead_submission_request import PatchedLeadSubmissionRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedLeadSubmissionRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedLeadSubmissionRequest): Serializer for lead form submission from frontend.
        body (PatchedLeadSubmissionRequest): Serializer for lead form submission from frontend.
        body (PatchedLeadSubmissionRequest): Serializer for lead form submission from frontend.
