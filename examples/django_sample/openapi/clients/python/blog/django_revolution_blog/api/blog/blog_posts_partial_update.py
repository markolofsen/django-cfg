...
from ...models.patched_post_update_request import PatchedPostUpdateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, PatchedPostUpdateRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        slug (str):
        body (PatchedPostUpdateRequest): Serializer for post updates.
        body (PatchedPostUpdateRequest): Serializer for post updates.
        body (PatchedPostUpdateRequest): Serializer for post updates.
