...
from ..models.post_update_status import check_post_update_status
from ..models.post_update_status import PostUpdateStatus
from ..types import UNSET, Unset
...
class PostUpdate:
    ...
    Attributes:
        ...
        status (Union[Unset, PostUpdateStatus]): * `draft` - Draft
            * `published` - Published
            * `archived` - Archived
    ...
    status: Union[Unset, PostUpdateStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, PostUpdateStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = check_post_update_status(_status)
