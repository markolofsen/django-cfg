...
T = TypeVar("T", bound="PaginatedCategoryList")
...
class PaginatedCategoryList:
    ...
    Attributes:
        ...
        results (list['Category']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Category.from_dict(results_item_data)
        ...
        paginated_category_list.additional_properties = d
        return paginated_category_list
