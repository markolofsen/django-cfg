...
from ..models.post_update_request_status import check_post_update_request_status
from ..models.post_update_request_status import PostUpdateRequestStatus
...
T = TypeVar("T", bound="PostUpdateRequest")
...
class PostUpdateRequest:
    ...
    Attributes:
        ...
        status (Union[Unset, PostUpdateRequestStatus]): * `draft` - Draft
            * `published` - Published
            * `archived` - Archived
    ...
    status: Union[Unset, PostUpdateRequestStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, PostUpdateRequestStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = check_post_update_request_status(_status)
        ...
        post_update_request.additional_properties = d
        return post_update_request
