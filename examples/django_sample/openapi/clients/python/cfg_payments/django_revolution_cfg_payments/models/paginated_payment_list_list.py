...
T = TypeVar("T", bound="PaginatedPaymentListList")


@_attrs_define
class PaginatedPaymentListList:
    """
    Attributes:
        ...
        results (list['PaymentList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PaymentList.from_dict(results_item_data)
        ...
        paginated_payment_list_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_payment_list_list.additional_properties = d
        return paginated_payment_list_list
