...
T = TypeVar("T", bound="PaginatedSubscriptionListList")


@_attrs_define
class PaginatedSubscriptionListList:
    """
    Attributes:
        ...
        results (list['SubscriptionList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SubscriptionList.from_dict(results_item_data)
        ...
        paginated_subscription_list_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_subscription_list_list.additional_properties = d
        return paginated_subscription_list_list
