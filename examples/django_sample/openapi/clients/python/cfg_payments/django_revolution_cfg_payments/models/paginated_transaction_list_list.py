...
T = TypeVar("T", bound="PaginatedTransactionListList")


@_attrs_define
class PaginatedTransactionListList:
    """
    Attributes:
        ...
        results (list['TransactionList']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TransactionList.from_dict(results_item_data)
        ...
        paginated_transaction_list_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_transaction_list_list.additional_properties = d
        return paginated_transaction_list_list
