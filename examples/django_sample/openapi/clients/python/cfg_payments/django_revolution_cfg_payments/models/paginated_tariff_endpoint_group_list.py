...
if TYPE_CHECKING:
    from ..models.tariff_endpoint_group import TariffEndpointGroup


T = TypeVar("T", bound="PaginatedTariffEndpointGroupList")


@_attrs_define
class PaginatedTariffEndpointGroupList:
    """
    Attributes:
        ...
        results (list['TariffEndpointGroup']): Array of items for current page
    ...
    has_next: bool
    has_previous: bool
    results: list["TariffEndpointGroup"]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = TariffEndpointGroup.from_dict(results_item_data)
        ...
        paginated_tariff_endpoint_group_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_tariff_endpoint_group_list.additional_properties = d
        return paginated_tariff_endpoint_group_list
