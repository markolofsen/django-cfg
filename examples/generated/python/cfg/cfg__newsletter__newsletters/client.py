...
class CfgNewslettersAPI:
    ...
    async def list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedNewsletterList]:
        """
        List Active Newsletters

        Get a list of all active newsletters available for subscription.
        """
        url = "/django_cfg_newsletter/newsletters/"
    ...
    async def retrieve(self, id: int) -> Newsletter:
        """
        Get Newsletter Details

        Retrieve details of a specific newsletter.
        """
        url = f"/django_cfg_newsletter/newsletters/{id}/"
