...
class CfgNewsletterAPI:
    ...
    async def cfg_newsletter_campaigns_partial_update(self, id: int, data: PatchedNewsletterCampaignRequest | None = None) -> NewsletterCampaign:
        """
    ...
    async def cfg_newsletter_unsubscribe_update(self, data: UnsubscribeRequest) -> Unsubscribe:
        """
    ...
    async def cfg_newsletter_unsubscribe_partial_update(self, data: PatchedUnsubscribeRequest | None = None) -> Unsubscribe:
        """
        Handle newsletter unsubscriptions.
        """
        url = "/cfg/newsletter/unsubscribe/"
