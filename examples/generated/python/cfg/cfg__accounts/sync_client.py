...
class SyncCfgAccountsAPI:
    """Synchronous API endpoints for Accounts."""

    def __init__(self, client: httpx.Client):
        """Initialize sync sub-client with shared httpx client."""
        self._client = client

    def otp_request_create(self, data: OTPRequestRequest) -> OTPRequestResponse:
        """
    ...
    def otp_verify_create(self, data: OTPVerifyRequest) -> OTPVerifyResponse:
        """
