...
class SyncCfgWebhooksAPI:
    ...
    def payments_webhooks_retrieve(self, provider: str) -> WebhookResponse:
        """
    ...
    def payments_webhooks_create(self, provider: str, data: WebhookResponseRequest) -> WebhookResponse:
        """
        Process Webhook
    ...
    def payments_webhooks_health_retrieve(self) -> WebhookHealth:
        """
    ...
    def payments_webhooks_providers_retrieve(self) -> SupportedProviders:
        """
    ...
    def payments_webhooks_stats_retrieve(self, days: int | None = None) -> WebhookStats:
        """
        Webhook Statistics
