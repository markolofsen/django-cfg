...
from ..enums import AdminPaymentUpdateRequeststatus, AdminPaymentUpdatestatus, Currencycurrency_type, PatchedAdminPaymentUpdateRequeststatus, PatchedPaymentRequestprovider, PatchedPaymentRequeststatus, PatchedSubscriptionRequeststatus, PatchedSubscriptionRequesttier, PaymentCreateRequestcurrency_code, PaymentCreateRequestprovider, PaymentCreatecurrency_code, PaymentCreateprovider, PaymentRequestprovider, PaymentRequeststatus, Paymentprovider, Paymentstatus, SubscriptionRequeststatus, SubscriptionRequesttier, Subscriptionstatus, Subscriptiontier, Transactiontransaction_type


class PaginatedAdminPaymentListList(BaseModel):
    """
...
class AdminPaymentCreate(BaseModel):
    ...
    user: int = ...
    amount_usd: float = Field(ge=1.0, le=100000.0)
...
class AdminPaymentDetail(BaseModel):
    ...
    status: str = ...
    status_display: str = ...
    pay_amount: str = Field(pattern='^-?\\d{0,12}(?:\\.\\d{0,8})?$')
    pay_address: str = ...
    payment_url: str = ...
...
class AdminPaymentUpdate(BaseModel):
    ...
    status: AdminPaymentUpdateStatus = Field(None, description='Current payment status\n\n* `pending` - Pending\n* `confirming` - Confirming\n* `confirmed` - Confirmed\n* `completed` - Completed\n* `failed` - Failed\n* `expired` - Expired\n* `cancelled` - Cancelled\n* `refunded` - Refunded')
    ...
    provider_data: str = Field(None, description='Provider-specific data (validated by Pydantic)')
    webhook_data: str = Field(None, description='Webhook data (validated by Pydantic)')
...
class AdminPaymentStats(BaseModel):
    ...
    success_rate: float = ...
    by_provider: dict[str, Any] = Field(description='Statistics by provider')
    by_currency: dict[str, Any] = Field(description='Statistics by currency')
    last_24h: dict[str, Any] = Field(description='Payments in last 24 hours')
    last_7d: dict[str, Any] = Field(description='Payments in last 7 days')
    last_30d: dict[str, Any] = Field(description='Payments in last 30 days')



class PaginatedAdminPaymentStatsList(BaseModel):
    """
...
class AdminUser(BaseModel):
    ...
    id: int = ...
    username: str = Field(description='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.')
    email: str = ...
    first_name: str = ...
    last_name: str = ...
    is_active: bool = Field(description='Designates whether this user should be treated as active. Unselect this instead of deleting accounts.')
...
class PaginatedWebhookStatsList(BaseModel):
    """
...
class PaginatedWebhookEventListList(BaseModel):
    """
...
class Currency(BaseModel):
    ...
    currency_type: CurrencyCurrencyType = Field(description='Type of currency\n\n* `fiat` - Fiat Currency\n* `crypto` - Cryptocurrency')
    type_display: str = ...
...
class Payment(BaseModel):
    ...
    provider: PaymentProvider = Field(None, description='Payment provider\n\n* `nowpayments` - NowPayments')
    status: PaymentStatus = Field(None, description='Current payment status\n\n* `pending` - Pending\n* `confirming` - Confirming\n* `confirmed` - Confirmed\n* `completed` - Completed\n* `failed` - Failed\n* `expired` - Expired\n* `cancelled` - Cancelled\n* `refunded` - Refunded')
    status_display: str = ...
...
class PaymentCreate(BaseModel):
    ...
    currency_code: PaymentCreateCurrencyCode = Field(description='Cryptocurrency to receive\n\n* `BTC` - Bitcoin\n* `ETH` - Ethereum\n* `LTC` - Litecoin\n* `XMR` - Monero\n* `USDT` - Tether\n* `USDC` - USD Coin\n* `ADA` - Cardano\n* `DOT` - Polkadot')
    provider: PaymentCreateProvider = Field(None, description='Payment provider\n\n* `nowpayments` - NowPayments')
...
class Subscription(BaseModel):
    ...
    status: SubscriptionStatus = Field(None, description='Subscription status\n\n* `active` - Active\n* `inactive` - Inactive\n* `suspended` - Suspended\n* `cancelled` - Cancelled\n* `expired` - Expired')
    status_display: str = ...
    status_color: str = Field(description='Get color for status display.')
    tier: SubscriptionTier = Field(None, description='Subscription tier\n\n* `free` - Free Tier\n* `basic` - Basic Tier\n* `pro` - Pro Tier\n* `enterprise` - Enterprise Tier')
...
class Transaction(BaseModel):
    ...
    amount_display: str = ...
    transaction_type: TransactionTransactionType = Field(description='Type of transaction\n\n* `deposit` - Deposit\n* `withdrawal` - Withdrawal\n* `payment` - Payment\n* `refund` - Refund\n* `fee` - Fee\n* `bonus` - Bonus\n* `adjustment` - Adjustment')
    type_color: str = ...
...
class AdminPaymentCreateRequest(BaseModel):
    ...
    user: int = ...
    amount_usd: float = Field(ge=1.0, le=100000.0)
    currency_code: str = Field(description='Provider currency code (e.g., BTC, ZROERC20)', min_length=1, max_length=20)
...
class AdminPaymentUpdateRequest(BaseModel):
    ...
    status: AdminPaymentUpdateRequestStatus = Field(None, description='Current payment status\n\n* `pending` - Pending\n* `confirming` - Confirming\n* `confirmed` - Confirmed\n* `completed` - Completed\n* `failed` - Failed\n* `expired` - Expired\n* `cancelled` - Cancelled\n* `refunded` - Refunded')
    description: str = Field(None, description='Payment description')
    callback_url: str | None = Field(None, description='Success callback URL', max_length=200)
    cancel_url: str | None = Field(None, description='Cancellation URL', max_length=200)
    provider_data: str = Field(None, description='Provider-specific data (validated by Pydantic)')
...
class PatchedAdminPaymentUpdateRequest(BaseModel):
    """
    Serializer for updating payments in admin interface.
    ...
    status: PatchedAdminPaymentUpdateRequestStatus = Field(None, description='Current payment status\n\n* `pending` - Pending\n* `confirming` - Confirming\n* `confirmed` - Confirmed\n* `completed` - Completed\n* `failed` - Failed\n* `expired` - Expired\n* `cancelled` - Cancelled\n* `refunded` - Refunded')
    description: str = Field(None, description='Payment description')
    callback_url: str | None = Field(None, description='Success callback URL', max_length=200)
    cancel_url: str | None = Field(None, description='Cancellation URL', max_length=200)
    provider_data: str = Field(None, description='Provider-specific data (validated by Pydantic)')
...
class WebhookStatsRequest(BaseModel):
    """
    Serializer for comprehensive webhook statistics.
...
class WebhookEventListRequest(BaseModel):
    """
    Serializer for paginated webhook events list.
...
class PaymentCreateRequest(BaseModel):
    ...
    amount_usd: float = Field(description='Amount in USD (1.00 - 50,000.00)', ge=1.0, le=50000.0)
    currency_code: PaymentCreateRequestCurrencyCode = Field(description='Cryptocurrency to receive\n\n* `BTC` - Bitcoin\n* `ETH` - Ethereum\n* `LTC` - Litecoin\n* `XMR` - Monero\n* `USDT` - Tether\n* `USDC` - USD Coin\n* `ADA` - Cardano\n* `DOT` - Polkadot')
    provider: PaymentCreateRequestProvider = Field(None, description='Payment provider\n\n* `nowpayments` - NowPayments')
    callback_url: str = Field(None, description='Success callback URL')
    cancel_url: str = Field(None, description='Cancellation URL')
    description: str = Field(None, description='Payment description', max_length=500)
    metadata: str = Field(None, description='Additional metadata')
...
class PaymentRequest(BaseModel):
    ...
    currency: int = Field(description='Payment currency')
    network: int | None = Field(None, description='Blockchain network (for crypto payments)')
    provider: PaymentRequestProvider = Field(None, description='Payment provider\n\n* `nowpayments` - NowPayments')
    status: PaymentRequestStatus = Field(None, description='Current payment status\n\n* `pending` - Pending\n* `confirming` - Confirming\n* `confirmed` - Confirmed\n* `completed` - Completed\n* `failed` - Failed\n* `expired` - Expired\n* `cancelled` - Cancelled\n* `refunded` - Refunded')
    callback_url: str | None = Field(None, description='Success callback URL', max_length=200)
    cancel_url: str | None = Field(None, description='Cancellation URL', max_length=200)
    description: str = Field(None, description='Payment description')
    expires_at: str | None = Field(None, description='When this payment expires')
...
class PatchedPaymentRequest(BaseModel):
    ...
    network: int | None = Field(None, description='Blockchain network (for crypto payments)')
    provider: PatchedPaymentRequestProvider = Field(None, description='Payment provider\n\n* `nowpayments` - NowPayments')
    status: PatchedPaymentRequestStatus = Field(None, description='Current payment status\n\n* `pending` - Pending\n* `confirming` - Confirming\n* `confirmed` - Confirmed\n* `completed` - Completed\n* `failed` - Failed\n* `expired` - Expired\n* `cancelled` - Cancelled\n* `refunded` - Refunded')
    callback_url: str | None = Field(None, description='Success callback URL', max_length=200)
    cancel_url: str | None = Field(None, description='Cancellation URL', max_length=200)
    description: str = Field(None, description='Payment description')
    expires_at: str | None = Field(None, description='When this payment expires')
...
class SubscriptionRequest(BaseModel):
    ...
    status: SubscriptionRequestStatus = Field(None, description='Subscription status\n\n* `active` - Active\n* `inactive` - Inactive\n* `suspended` - Suspended\n* `cancelled` - Cancelled\n* `expired` - Expired')
    tier: SubscriptionRequestTier = Field(None, description='Subscription tier\n\n* `free` - Free Tier\n* `basic` - Basic Tier\n* `pro` - Pro Tier\n* `enterprise` - Enterprise Tier')
    expires_at: str = Field(description='When this subscription expires')
...
class PatchedSubscriptionRequest(BaseModel):
    ...
    status: PatchedSubscriptionRequestStatus = Field(None, description='Subscription status\n\n* `active` - Active\n* `inactive` - Inactive\n* `suspended` - Suspended\n* `cancelled` - Cancelled\n* `expired` - Expired')
    tier: PatchedSubscriptionRequestTier = Field(None, description='Subscription tier\n\n* `free` - Free Tier\n* `basic` - Basic Tier\n* `pro` - Pro Tier\n* `enterprise` - Enterprise Tier')
