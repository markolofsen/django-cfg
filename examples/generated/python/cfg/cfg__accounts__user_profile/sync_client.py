...
class SyncCfgUserProfileAPI:
    ...
    def profile_retrieve(self) -> User:
        """
    ...
    def profile_avatar_create(self, data: InlineRequestBody) -> User:
        """
        Upload user avatar
    ...
    def profile_partial_update(self, data: UserProfileUpdateRequest) -> User:
        """
    ...
    def profile_partial_partial_update(self, data: PatchedUserProfileUpdateRequest | None = None) -> User:
        """
        Partial update user profile
    ...
    def profile_update_update(self, data: UserProfileUpdateRequest) -> User:
        """
        Update user profile
    ...
    def profile_update_partial_update(self, data: PatchedUserProfileUpdateRequest | None = None) -> User:
        """
        Update user profile
