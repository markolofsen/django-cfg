...
class SyncCfgLeadsAPI:
    """Synchronous API endpoints for Cfg Leads."""

    def __init__(self, client: httpx.Client):
        """Initialize sync sub-client with shared httpx client."""
        self._client = client

    def cfg_leads_leads_list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedLeadSubmissionList]:
        """
    ...
    def cfg_leads_leads_create(self, data: LeadSubmissionRequest) -> LeadSubmission:
        """
        ViewSet for Lead model. Provides only submission functionality for leads
        from frontend forms.
        """
    ...
    def cfg_leads_leads_retrieve(self, id: int) -> LeadSubmission:
        """
        ViewSet for Lead model. Provides only submission functionality for leads
        from frontend forms.
        """
    ...
    def cfg_leads_leads_update(self, id: int, data: LeadSubmissionRequest) -> LeadSubmission:
        """
        ViewSet for Lead model. Provides only submission functionality for leads
        from frontend forms.
        """
    ...
    def cfg_leads_leads_partial_update(self, id: int, data: PatchedLeadSubmissionRequest | None = None) -> LeadSubmission:
        """
        ViewSet for Lead model. Provides only submission functionality for leads
        from frontend forms.
        """
    ...
    def cfg_leads_leads_destroy(self, id: int) -> None:
        """
        ViewSet for Lead model. Provides only submission functionality for leads
        from frontend forms.
        """
