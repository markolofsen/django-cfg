...
class ShopBlogCategoriesAPI:
    ...
    async def list(self, ordering: str | None = None, page: int | None = None, page_size: int | None = None, search: str | None = None) -> list[PaginatedBlogCategoryList]:
        """
        List categories
    ...
    async def create(self, data: BlogCategoryRequest) -> BlogCategory:
        """
        Create category
    ...
    async def retrieve(self, slug: str) -> BlogCategory:
        """
        Get category
    ...
    async def update(self, slug: str, data: BlogCategoryRequest) -> BlogCategory:
        """
        Update category
