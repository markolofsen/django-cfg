...
class ShopProductsAPI:
    ...
    async def list(self, category: int | None = None, is_digital: bool | None = None, is_featured: bool | None = None, ordering: str | None = None, page: int | None = None, page_size: int | None = None, search: str | None = None, status: str | None = None) -> list[PaginatedProductListList]:
        """
        List products
    ...
    async def featured_retrieve(self) -> ProductDetail:
        """
    ...
    async def stats_retrieve(self) -> ShopStats:
        """
        Get shop statistics
