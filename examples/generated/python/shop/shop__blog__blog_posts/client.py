...
class ShopBlogPostsAPI:
    ...
    async def list(self, author: int | None = None, category: int | None = None, is_featured: bool | None = None, ordering: str | None = None, page: int | None = None, page_size: int | None = None, search: str | None = None, status: str | None = None, tags: list | None = None) -> list[PaginatedPostListList]:
        """
        List posts
    ...
    async def likes_list(self, slug: str, author: int | None = None, category: int | None = None, is_featured: bool | None = None, ordering: str | None = None, page: int | None = None, page_size: int | None = None, search: str | None = None, status: str | None = None, tags: list | None = None) -> list[PaginatedPostLikeList]:
        """
        Get post likes
