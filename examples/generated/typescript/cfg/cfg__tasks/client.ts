...
export class CfgTasksAPI {
  ...
  async apiClearCreate(data: Models.APIResponseRequest): Promise<Models.APIResponse> {
    const response = await this.client.request('POST', "/tasks/api/clear/", { body: data });
    return response;
  }
  ...
  async apiClearQueuesCreate(data: Models.APIResponseRequest): Promise<Models.APIResponse> {
    const response = await this.client.request('POST', "/tasks/api/clear-queues/", { body: data });
    return response;
  }
  ...
  async apiPurgeFailedCreate(data: Models.APIResponseRequest): Promise<Models.APIResponse> {
    const response = await this.client.request('POST', "/tasks/api/purge-failed/", { body: data });
    return response;
  }
  ...
  async apiQueuesManageCreate(data: Models.QueueActionRequest): Promise<Models.QueueAction> {
    const response = await this.client.request('POST', "/tasks/api/queues/manage/", { body: data });
    return response;
  }
  ...
  async apiQueuesStatusRetrieve(): Promise<Models.QueueStatus> {
    const response = await this.client.request('GET', "/tasks/api/queues/status/");
    return response;
  }
  ...
  async apiSimulateCreate(data: Models.APIResponseRequest): Promise<Models.APIResponse> {
    const response = await this.client.request('POST', "/tasks/api/simulate/", { body: data });
    return response;
  }
  ...
  async apiTasksListRetrieve(): Promise<Models.APIResponse> {
    const response = await this.client.request('GET', "/tasks/api/tasks/list/");
    return response;
  }
  ...
  async apiTasksStatsRetrieve(): Promise<Models.TaskStatistics> {
    const response = await this.client.request('GET', "/tasks/api/tasks/stats/");
    return response;
  }
  ...
  async apiWorkersListRetrieve(): Promise<Models.APIResponse> {
    const response = await this.client.request('GET', "/tasks/api/workers/list/");
    return response;
  }
  ...
  async apiWorkersManageCreate(data: Models.WorkerActionRequest): Promise<Models.WorkerAction> {
    const response = await this.client.request('POST', "/tasks/api/workers/manage/", { body: data });
    return response;
  }
