...
from ..enums import PostCreate.status, PostCreateRequest.status, PostDetail.status, PostDetailRequest.status, PostUpdate.status, PostUpdateRequest.status
...
Request model (no read-only fields)."""
    ...
    tags: list[int] = None
    status: PostCreateRequest.status = Field(None, description='* `draft` - Draft\n* `published` - Published\n* `archived` - Archived')
...
Response model (includes read-only fields)."""
    ...
    category: int | None = None
    tags: list[int] = None
    status: PostCreate.status = Field(None, description='* `draft` - Draft\n* `published` - Published\n* `archived` - Archived')
    is_featured: bool = None
    allow_comments: bool = None
    meta_title: str = Field(None, max_length=60)
    meta_description: str = Field(None, max_length=160)
...
Response model (includes read-only fields)."""
    ...
    status: PostDetail.status = Field(None, description='* `draft` - Draft\n* `published` - Published\n* `archived` - Archived')
    is_featured: bool = None
    allow_comments: bool = None
    meta_title: str = Field(None, max_length=60)
    meta_description: str = Field(None, max_length=160)
...
Request model (no read-only fields)."""
    ...
    category: int | None = None
    tags: list[int] = None
    status: PostUpdateRequest.status = Field(None, description='* `draft` - Draft\n* `published` - Published\n* `archived` - Archived')
    is_featured: bool = None
    allow_comments: bool = None
    meta_title: str = Field(None, max_length=60)
    meta_description: str = Field(None, max_length=160)
...
Request model (no read-only fields)."""
    ...
    content: str = Field(min_length=1)
    excerpt: str = Field(None, description='Brief description', max_length=500)
    status: PostDetailRequest.status = Field(None, description='* `draft` - Draft\n* `published` - Published\n* `archived` - Archived')
    is_featured: bool = None
    allow_comments: bool = None
    meta_title: str = Field(None, max_length=60)
    meta_description: str = Field(None, max_length=160)
