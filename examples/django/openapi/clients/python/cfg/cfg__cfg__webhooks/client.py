...
class CfgWebhooksAPI:
    ...
    async def cfg_payments_webhooks_retrieve(self, provider: str) -> WebhookResponse:
        """
    ...
    async def cfg_payments_webhooks_create(self, provider: str, data: WebhookResponseRequest) -> WebhookResponse:
        """
        Process Webhook
    ...
    async def cfg_payments_webhooks_health_retrieve(self) -> WebhookHealth:
        """
    ...
    async def cfg_payments_webhooks_providers_retrieve(self) -> SupportedProviders:
        """
    ...
    async def cfg_payments_webhooks_stats_retrieve(self, days: int | None = None) -> WebhookStats:
        """
        Webhook Statistics
