...
class CfgSubscriptionsAPI:
    ...
    async def cfg_newsletter_subscribe_create(self, data: SubscribeRequest) -> SubscribeResponse:
        """
    ...
    async def cfg_newsletter_subscriptions_list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedNewsletterSubscriptionList]:
        """
    ...
    async def cfg_newsletter_unsubscribe_create(self, data: UnsubscribeRequest) -> SuccessResponse:
        """
