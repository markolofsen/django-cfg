...
class SyncCfgSubscriptionsAPI:
    ...
    def cfg_newsletter_subscribe_create(self, data: SubscribeRequest) -> SubscribeResponse:
        """
    ...
    def cfg_newsletter_subscriptions_list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedNewsletterSubscriptionList]:
        """
    ...
    def cfg_newsletter_unsubscribe_create(self, data: UnsubscribeRequest) -> SuccessResponse:
        """
