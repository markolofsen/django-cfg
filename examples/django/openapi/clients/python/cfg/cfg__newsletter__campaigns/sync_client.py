...
class SyncCfgCampaignsAPI:
    ...
    def list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedNewsletterCampaignList]:
        """
    ...
    def create(self, data: NewsletterCampaignRequest) -> NewsletterCampaign:
        """
    ...
    def retrieve(self, id: int) -> NewsletterCampaign:
        """
    ...
    def update(self, id: int, data: NewsletterCampaignRequest) -> NewsletterCampaign:
        """
        Update Campaign
    ...
    def send_create(self, data: SendCampaignRequest) -> SendCampaignResponse:
        """
