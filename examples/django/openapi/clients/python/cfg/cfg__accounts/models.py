...
from ..enums import OTPRequestRequest.channel, OTPVerifyRequest.channel
...
Request model (no read-only fields)."""
    ...
    channel: OTPRequestRequest.channel = Field(None, description="Delivery channel: 'email' or 'phone'. Auto-detected if not provided.\n\n* `email` - Email\n* `phone` - Phone")
...
Request model (no read-only fields)."""
    ...
    channel: OTPVerifyRequest.channel = Field(None, description="Delivery channel: 'email' or 'phone'. Auto-detected if not provided.\n\n* `email` - Email\n* `phone` - Phone")
