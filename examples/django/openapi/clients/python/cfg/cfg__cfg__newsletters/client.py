...
class CfgNewslettersAPI:
    ...
    async def cfg_newsletter_newsletters_list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedNewsletterList]:
        """
    ...
    async def cfg_newsletter_newsletters_retrieve(self, id: int) -> Newsletter:
        """
