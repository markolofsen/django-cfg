...
class SyncCfgUserProfileAPI:
    ...
    def cfg_accounts_profile_retrieve(self) -> User:
        """
    ...
    def cfg_accounts_profile_avatar_create(self, data: InlineRequestBody) -> User:
        """
        Upload user avatar
    ...
    def cfg_accounts_profile_partial_update(self, data: UserProfileUpdateRequest) -> User:
        """
    ...
    def cfg_accounts_profile_partial_partial_update(self, data: PatchedUserProfileUpdateRequest | None = None) -> User:
        """
        Partial update user profile
    ...
    def cfg_accounts_profile_update_update(self, data: UserProfileUpdateRequest) -> User:
        """
        Update user profile
    ...
    def cfg_accounts_profile_update_partial_update(self, data: PatchedUserProfileUpdateRequest | None = None) -> User:
        """
        Update user profile
