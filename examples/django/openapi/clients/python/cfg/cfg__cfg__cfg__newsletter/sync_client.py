...
class SyncCfgNewsletterAPI:
    """Synchronous API endpoints for Cfg Newsletter."""

    def __init__(self, client: httpx.Client):
        """Initialize sync sub-client with shared httpx client."""
        self._client = client

    def cfg_newsletter_campaigns_partial_update(self, id: int, data: PatchedNewsletterCampaignRequest | None = None) -> NewsletterCampaign:
        """
    ...
    def cfg_newsletter_unsubscribe_update(self, data: UnsubscribeRequest) -> Unsubscribe:
        """
    ...
    def cfg_newsletter_unsubscribe_partial_update(self, data: PatchedUnsubscribeRequest | None = None) -> Unsubscribe:
        """
        Handle newsletter unsubscriptions.
        """
        url = "/cfg/newsletter/unsubscribe/"
