...
class CfgSubscriptionsAPI:
    ...
    async def subscribe_create(self, data: SubscribeRequest) -> SubscribeResponse:
    ...
    async def list(self, page: int | None = None, page_size: int | None = None) -> list[PaginatedNewsletterSubscriptionList]:
    ...
    async def unsubscribe_create(self, data: UnsubscribeRequest) -> SuccessResponse:
