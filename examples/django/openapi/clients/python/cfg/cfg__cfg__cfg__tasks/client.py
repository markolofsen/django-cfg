...
class CfgTasksAPI:
    ...
    async def cfg_tasks_api_clear_create(self, data: APIResponseRequest) -> APIResponse:
        """
    ...
    async def cfg_tasks_api_clear_queues_create(self, data: APIResponseRequest) -> APIResponse:
        """
    ...
    async def cfg_tasks_api_purge_failed_create(self, data: APIResponseRequest) -> APIResponse:
        """
    ...
    async def cfg_tasks_api_queues_manage_create(self, data: QueueActionRequest) -> QueueAction:
        """
    ...
    async def cfg_tasks_api_queues_status_retrieve(self) -> QueueStatus:
        """
    ...
    async def cfg_tasks_api_simulate_create(self, data: APIResponseRequest) -> APIResponse:
        """
    ...
    async def cfg_tasks_api_tasks_list_retrieve(self) -> APIResponse:
        """
    ...
    async def cfg_tasks_api_tasks_stats_retrieve(self) -> TaskStatistics:
        """
    ...
    async def cfg_tasks_api_workers_list_retrieve(self) -> APIResponse:
        """
    ...
    async def cfg_tasks_api_workers_manage_create(self, data: WorkerActionRequest) -> WorkerAction:
        """
