...
export interface PostCreateRequest {
  ...
  * `published` - Published
  * `archived` - Archived */
  status?: Enums.PostCreateRequest.status;
  is_featured?: boolean;
...
export interface PostCreate {
  ...
  * `published` - Published
  * `archived` - Archived */
  status?: Enums.PostCreate.status;
  is_featured?: boolean;
  allow_comments?: boolean;
  meta_title?: string;
  meta_description?: string;
...
export interface PostDetail {
  ...
  * `published` - Published
  * `archived` - Archived */
  status?: Enums.PostDetail.status;
  is_featured?: boolean;
  allow_comments?: boolean;
  meta_title?: string;
  meta_description?: string;
...
export interface PostUpdateRequest {
  ...
  * `published` - Published
  * `archived` - Archived */
  status?: Enums.PostUpdateRequest.status;
  is_featured?: boolean;
  allow_comments?: boolean;
  meta_title?: string;
  meta_description?: string;
...
export interface PostDetailRequest {
  ...
  * `published` - Published
  * `archived` - Archived */
  status?: Enums.PostDetailRequest.status;
  is_featured?: boolean;
  allow_comments?: boolean;
  meta_title?: string;
  meta_description?: string;
...
export interface PostLike {
  ...
  * `sad` - 😢
  * `angry` - 😠 */
  reaction?: Enums.PostLike.reaction;
  created_at: string;
}
