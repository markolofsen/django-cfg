...
export const ProductDetailSchema = z.object({
  ...
  sale_price: z.string().regex(/^-?\\d{0,8}(?:\\.\\d{0,2})?$/).optional().nullable(),
  ...
  weight: z.string().regex(/^-?\\d{0,6}(?:\\.\\d{0,2})?$/).optional().nullable(),
  length: z.string().regex(/^-?\\d{0,6}(?:\\.\\d{0,2})?$/).optional().nullable(),
  width: z.string().regex(/^-?\\d{0,6}(?:\\.\\d{0,2})?$/).optional().nullable(),
  height: z.string().regex(/^-?\\d{0,6}(?:\\.\\d{0,2})?$/).optional().nullable(),
