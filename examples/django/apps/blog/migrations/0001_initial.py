    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excerpt', models.TextField(blank=True, help_text='Brief description', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['post', 'is_approved'], name='blog_commen_post_id_7710b1_idx'), models.Index(fields=['author', 'is_approved'], name='blog_commen_author__e7ef5e_idx')],
            },
        ),
        migrations.CreateModel(
            name='PostLike',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reaction', models.CharField(choices=[('like', '👍'), ('love', '❤️'), ('laugh', '😂'), ('wow', '😮'), ('sad', '😢'), ('angry', '😠')], default='like', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['post', 'created_at'], name='blog_post_v_post_id_c819f6_idx'), models.Index(fields=['user', 'created_at'], name='blog_post_v_user_id_4349ff_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='post',
