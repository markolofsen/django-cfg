...
class CfgRqMonitoringAPI:
    ...
    async def rq_monitor_config_retrieve(self) -> RQConfig:
        """
    ...
    async def rq_monitor_health_retrieve(self) -> RQHealthCheck:
        """
        Health check
    ...
    async def rq_monitor_metrics_retrieve(self) -> None:
        """
        Prometheus metrics
