...
class SyncCfgUserProfileAPI:
    ...
    def accounts_profile_avatar_create(
        self,
    ...
    def accounts_profile_delete_create(self) -> AccountDeleteResponse:
        """
        Delete user account
    ...
    def accounts_profile_partial_partial_update(
        self,
    ...
    def accounts_profile_update_partial_update(
        self,
        data: PatchedUserProfileUpdateRequest | None = None,
    ) -> User:
        """
