...
class IngestService:
    ...
    def ingest_batch(
        ...
        from django_cfg.apps.system.frontend_monitor.services.notifications import NotificationService
    ...
    def _is_duplicate(self, data: dict, window_seconds: int) -> bool:
        ...
        from django_cfg.apps.system.frontend_monitor.models import FrontendEvent
