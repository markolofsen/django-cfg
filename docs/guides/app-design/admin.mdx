...
<Callout type="info">
For a full reference on the admin system including all field types and configuration options, see the [Django Admin module docs](/features/modules/django-admin).
</Callout>
