...
See: [**Docker Production Setup**](./docker/production)
...
✅ **Secrets not in code** - Use config.yaml (gitignored) or env vars
✅ **Validation** - Invalid config fails at startup (not in production)
✅ **Type safety** - No string injection vulnerabilities
✅ **Smart defaults** - Security headers enabled automatically
✅ **SSL/HSTS** - Auto-configured in production via `security_domains`
...
class MyConfig(DjangoConfig):
    debug: bool = os.environ.get("ENV", "development") == "development"
```
    ...
    databases: dict[str, DatabaseConfig] = Field(
        default_factory=lambda: {
            "default": DatabaseConfig(
                ...
                engine="django.db.backends.sqlite3" if os.environ.get("ENV") == "development"
                    else "django.db.backends.postgresql",
                name="db.sqlite3" if os.environ.get("ENV") == "development"
...
**Community Support**:
- 📚 [**Documentation**](https://docs.djangocfg.com) - Comprehensive guides
- 💬 [**GitHub Discussions**](https://github.com/markolofsen/django-cfg/discussions) - Ask questions
- 🐛 [**GitHub Issues**](https://github.com/markolofsen/django-cfg/issues) - Report bugs
...
**Roadmap**: [GitHub Projects](https://github.com/markolofsen/django-cfg/issues)
...
### Deep Dives
- [**Type-Safe Configuration**](../../core/type-safety) - Technical deep-dive
- [**vs Alternatives**](../../getting-started/django-cfg-vs-alternatives) - Detailed comparison

### Business Case
- [**Problems Solved**](./django-configuration-problems-solved) - 10 common issues

---

**Still have questions?** → [Ask on GitHub Discussions](https://github.com/markolofsen/django-cfg/discussions)
