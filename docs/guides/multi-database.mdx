...
class MyConfig(DjangoConfig):
    databases: dict[str, DatabaseConfig] = {
        ...
        'blog_db': DatabaseConfig.from_url(env.database.url_blog),
        'shop_db': DatabaseConfig.from_url(env.database.url_shop),
        'analytics': DatabaseConfig.from_url(env.database.url_analytics),
    }
    database_routing_rules: dict[str, str] = {
        'blog': 'blog_db',
        'shop': 'shop_db',
        'analytics': 'analytics',
    }
...
**Core Database Setup:**
- [**Database Configuration**](../../database) - Complete database configuration guide
- [**Database Routing**](../../core/routing) - Advanced routing strategies and patterns
- [**Configuration Models**](../../configuration) - Database config API reference

**Infrastructure:**
- [**Cache Configuration**](../../configuration/cache) - Redis for multi-database caching
- [**Environment Detection**](../../configuration/environment) - Database per environment
- [**Docker Deployment**](./docker/production) - Multi-database in Docker
...
- [**Environment Variables**](../../configuration/environment) - Secure database credentials
- [**Type-Safe Configuration**](../../core/type-safety) - Database config validation
...
- [**ReArq Integration**](../../features/modules/django-rq/overview) - Task routing per database
