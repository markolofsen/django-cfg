...
### **[E-commerce Applications](../../features/modules/currency/overview)**
- Multi-currency product catalogs
- Shopping cart with currency conversion
- Dynamic pricing

### **[Financial Applications](../../features/modules/currency/overview)**
- Crypto portfolio tracking
- Investment returns calculator
- Multi-asset tracking

### **[Import/Export Business](../../features/modules/currency/overview)**
- Vehicle import cost calculator
- Global pricing strategies
- International shipping costs

### **[Gaming & Entertainment](../../features/modules/currency/overview)**
- In-game currency exchange
- Regional pricing for game items
- Optimal purchase calculator

### **[Business Intelligence](../../features/modules/currency/overview)**
...
### **[Payments Examples](../../features/built-in-apps/payments/overview)**
- Stripe integration
...
**Building E-commerce?**
→ See [Currency Examples](../../features/modules/currency/overview) and [Payments Examples](../../features/built-in-apps/payments/overview)
