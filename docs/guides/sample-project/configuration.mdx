    ...
    unfold: UnfoldConfig = UnfoldConfig(
        ...
        navigation=[
            NavigationSection(
                ...
                separator=True,
                items=[
                    NavigationItem(title="Profiles", icon=Icons.PERSON, link="admin:profiles_profile_changelist"),
                ],
            ),
            NavigationSection(
...
# Create and register config instance
...
media_url: str = "/media/"  # Or set from env: env.app.media_url
```
...
Unfold theme customization with typed config objects:
...
- [Environment Configuration](/docs/configuration/environment) - Detailed ENV guide
