...
- **Health Check:** `GET /healthz/ready`
...
carapis-django:
  ...
  volumes:
    ...
    - ./volumes/django/media:/app/media  # User uploads (drop this when storage.backend is set)
  depends_on:
    carapis_postgres:
...
# Storing uploads in object storage instead of the media volume:
# configure storage.backend in config.py, then supply credentials here.
...
**Infrastructure:**
- [**Database Configuration**](/database) - PostgreSQL and multi-database setup
- [**Cache Configuration**](/configuration/cache) - Redis configuration and caching
- [**Security Settings**](/configuration/security) - CORS, CSRF, SSL configuration

### Background Processing

**Task Processing:**
- [**ReArq Integration**](/features/modules/django-rq) - Background task processing
- [**Background Task Commands**](/features/modules/django-rq) - Manage workers via CLI
...
- [**Environment Variables**](/configuration/environment) - Secure secrets management
