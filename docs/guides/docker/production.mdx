...
carapis-django:
  ...
  volumes:
    ...
    - ./volumes/django/media:/app/media  # User uploads (skip if using CDN/S3)
  depends_on:
    carapis_postgres:
...
MEDIA_URL=/media/  # Relative URL (served by nginx)
# MEDIA_URL=https://cdn.example.com/media/  # CDN for production (recommended)
# MEDIA_URL=__auto__  # Auto-generate from api_url
...
- [**Logging Configuration**](/docs/deployment/logging) - Production logging
- [**Production Config**](../../production-config) - Best practices
- [**Environment Detection**](/docs/fundamentals/configuration/environment) - Multi-environment setup

**Infrastructure:**
- [**Database Configuration**](/docs/fundamentals/database) - PostgreSQL and multi-database setup
- [**Cache Configuration**](/docs/fundamentals/configuration/cache) - Redis configuration and caching
- [**Security Settings**](/docs/fundamentals/configuration/security) - CORS, CSRF, SSL configuration

### Background Processing

**Task Processing:**
- [**ReArq Integration**](/docs/features/integrations/django-rq/overview) - Background task processing
- [**Background Task Commands**](/docs/features/integrations/django-rq/overview) - Manage workers via CLI
- [**Tasks App**](/docs/features/built-in-apps/operations/tasks) - Built-in task management

### Configuration & Setup

**Getting Started:**
- [**Installation**](/docs/getting-started/installation) - Install Django-CFG
- [**Configuration Guide**](/docs/getting-started/configuration) - YAML configuration setup
- [**First Project**](/docs/getting-started/first-project) - Quick start tutorial

**Production Configuration:**
- [**Configuration Models**](/docs/fundamentals/configuration) - Complete config API
- [**Environment Variables**](/docs/fundamentals/configuration/environment) - Secure secrets management
- [**Type-Safe Configuration**](/docs/fundamentals/core/type-safety) - Pydantic patterns

### Tools & Guides

**CLI & Monitoring:**
- [**CLI Tools**](/docs/cli/introduction) - Command-line interface
- [**Core Commands**](/docs/cli/commands/core-commands) - Essential management commands
