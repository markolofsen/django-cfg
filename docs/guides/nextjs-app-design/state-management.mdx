...
<Callout type="info">
For Zustand store patterns, persistence, and undo/redo see [Zustand recipe](/guides/nextjs-app-design/recipes/zustand). For generated SWR hooks see [Data Layer](/guides/nextjs-app-design/data-layer).
</Callout>
