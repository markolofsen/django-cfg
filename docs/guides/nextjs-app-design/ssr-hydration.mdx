...
<Callout type="info">
For generated API clients and SWR hooks see [Data Layer](/guides/nextjs-app-design/data-layer). For Context architecture see [State Management](/guides/nextjs-app-design/state-management).
</Callout>
