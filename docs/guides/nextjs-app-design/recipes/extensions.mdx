...
<Callout type="info">
For the generated API layer that extensions build on see [Data Layer](/guides/nextjs-app-design/data-layer). For Context architecture see [State Management](/guides/nextjs-app-design/state-management).
</Callout>
