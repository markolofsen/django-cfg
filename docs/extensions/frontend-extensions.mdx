...
```typescript
// ❌ Wrong - importing client hooks in server component
import { useTickets } from '@djangocfg/ext-support';

// ✅ Correct - use client-safe import
import { ExtSupportClient } from '@djangocfg/ext-support';  // Server OK

// ✅ Or add 'use client' directive
'use client';
...
**A:** Check the [the django-cfg repo](https://github.com/markolofsen/django-cfg) for all published packages. Most backend extensions have corresponding frontend packages.
