...
```python filename="django_cfg/registry/__init__.py"
DJANGO_CFG_REGISTRY = {
...
```python filename="django_cfg/__init__.py"
...
- **`services.py`** - DjangoEmailService, DjangoTelegram, DjangoLogger
...
- **Communication**: `test_email`, `test_telegram`
...
**Configuration:**
- **[Configuration](../../configuration)** - Complete configuration API reference
...
- **[First Project](/docs/getting-started/first-project)** - Create your first project
- **[Configuration Guide](/docs/getting-started/configuration)** - YAML configuration setup

**Features:**
- **[Built-in Apps](/docs/features/built-in-apps/overview)** - Production-ready applications
- **[Modules Overview](/docs/features/modules/overview)** - Reusable modules system
- **[Integrations Overview](/docs/features/integrations/overview)** - Third-party integrations
...
**Production:**
- **[Production Config](/docs/guides/production-config)** - Production deployment guide
- **[Docker Deployment](/docs/guides/docker/production)** - Containerized deployment
