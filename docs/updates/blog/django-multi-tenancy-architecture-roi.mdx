...
[Get Started](/getting-started/intro) | [Architecture Guide](/core/architecture)
</Callout>
...
- **[Core Architecture Documentation](/core/architecture)** - Deep dive into Django-CFG architectural patterns
- **[Configuration Debt Analysis](./django-configuration-debt-analysis)** - Understand the cost of manual infrastructure setup
- **[Getting Started Guide](/getting-started/intro)** - Install Django-CFG and create your first multi-tenant project
- **[Production Deployment](/guides/docker/production)** - Deploy multi-tenant applications to production
- **[Environment Configuration](/deployment/environment-setup)** - Configure production environments for multi-tenancy
...
**Want to learn more?** Check out our [Performance Optimization Guide](./django-performance-optimization-guide).
