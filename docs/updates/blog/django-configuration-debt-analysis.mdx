...
[Get Started](/docs/getting-started/intro) | [See Live Demo](/docs/getting-started/first-project)
</Callout>
...
- **[Configuration Guide](/docs/configuration)** - Master Django-CFG configuration
...
**Want to dive deeper?** Check out our [First Project Guide](/docs/getting-started/first-project).
