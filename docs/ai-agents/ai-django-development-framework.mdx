...
**Tool Capabilities** (see [Toolsets Guide](../toolsets) for advanced patterns):
...
Coordinate multiple agents for complex workflows (see [Orchestration Guide](../orchestration)):
...
2. **[Create First Agent](../creating-agents)** - Detailed agent tutorial
3. **[Build Workflows](../orchestration)** - Multi-agent coordination
4. **[Production Deploy](../../guides/docker/production)** - Docker setup for agents

### Learn More

- **[AI Agents Introduction](../introduction)** - Core concepts
- **[Django Integration](../django-integration)** - ORM, admin, auth
