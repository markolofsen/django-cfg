...
### [Django-RQ Integration](../modules/django-rq/overview)
...
**Use Cases:**
- Email sending and notifications ([Email Module](../modules/django-email/overview))
- Document processing
- Bulk operations (Newsletter campaigns, data imports)
- Scheduled tasks (cleanup jobs, report generation)

[**Full Django-RQ Guide →**](../modules/django-rq/overview)

### 🔧 Development Tools

### [Ngrok Integration](../modules/django-ngrok/overview)
...
[**Full Ngrok Guide →**](../modules/django-ngrok/overview)
...
All integrations use [Pydantic v2](/docs/core/type-safety) for validation:
...
Enable integrations per environment using [environment detection](/docs/configuration/environment):
...
- **[Django-RQ Overview](../modules/django-rq/overview)** - Complete task queue guide
...
**Development Tools:**
- **[Ngrok Overview](../modules/django-ngrok/overview)** - Webhook testing guide
...
**Communication:**
- **[Telegram Module](../modules/django-telegram/overview)** - Bot notifications
- **[Email Module](../modules/django-email/overview)** - Email sending

### Configuration & Setup

**Getting Started:**
- **[Configuration Guide](/docs/getting-started/configuration)** - Enable integrations
- **[Configuration Models](/docs/configuration)** - Integration config API
- **[Environment Detection](/docs/configuration/environment)** - Environment-specific integrations

**Infrastructure:**
- **[Redis Configuration](/docs/configuration/cache)** - Redis setup for Django-RQ
- **[Security Settings](/docs/configuration/security)** - Webhook signature verification
- **[Environment Variables](/docs/configuration/environment)** - Manage API keys securely

### Related Features

**Other Modules:**
- **[Modules Overview](../modules/overview)** - All available modules
- **[LLM Module](../modules/django-llm/overview)** - AI model integration
...
**New to Integrations?**
1. Start with [Django-RQ Overview](../modules/django-rq/overview) for background tasks
2. Try [Ngrok Overview](../modules/django-ngrok/overview) for webhook testing
3. Review [Integration Patterns](./patterns) for best practices

**Ready for Production?**
1. Review [Production Config](/docs/guides/production-config)
2. Set up [Redis](/docs/configuration/cache) for Django-RQ
3. Configure [environment variables](/docs/configuration/environment) for secrets
