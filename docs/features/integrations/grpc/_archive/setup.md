...
```bash
# Recommended: Install django-cfg with grpc extras
...
# Using poetry
poetry add grpcio grpcio-tools grpcio-reflection grpcio-health-checking protobuf
```

**Packages:**
- `grpcio` - gRPC framework
- `grpcio-tools` - Protocol Buffer compiler
- `grpcio-reflection` - Server reflection support
...
>>> 'django_cfg.apps.integrations.grpc' in settings.INSTALLED_APPS
True
```
...
Expected output:
```
/admin/integrations/grpc/grpcrequestlog/          admin:grpc_grpcrequestlog_changelist
/cfg/integrations/grpc/monitor/overview/          django_cfg_grpc:monitor-overview
/cfg/integrations/grpc/monitor/requests/          django_cfg_grpc:monitor-requests
/cfg/integrations/grpc/services/                  django_cfg_grpc:services-list
...
```
