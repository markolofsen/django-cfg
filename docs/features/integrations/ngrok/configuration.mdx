...
- [**Payments Configuration**](/docs/features/built-in-apps/payments/overview) - Payment setup
- [**Payment Examples**](/docs/features/built-in-apps/payments/overview) - Real payment flows
