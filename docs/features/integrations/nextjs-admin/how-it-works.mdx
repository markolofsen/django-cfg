...
```python filename="django_cfg/modules/nextjs_admin/models/config.py"
...
```python filename="django_cfg/core/builders/apps_builder.py"
...
```django filename="django_cfg/templates/admin/index.html"
{% load nextjs_admin %}
...
```python filename="django_cfg/apps/frontend/views.py"
...
```python filename="django_cfg/modules/django_client/management/commands/generate_client.py"
...
cp -r openapi/clients/typescript/* \
    ../django_admin/apps/admin/app/_lib/api/generated/
```
...
```javascript filename="Next.js Theme Hook"
