...
config = DjangoConfig(
    ...
    nextjs_admin=NextJsAdminConfig(
        ...
        api_output_path="src/app/_lib/api/generated",  # Custom API path
...
```typescript filename="src/app/_lib/api/client.ts"
...
import { createProfilesClient } from '@/_lib/api/client';
import { Profile } from '@/_lib/api/generated/profiles/types';
...
```typescript filename="apps/analytics-dashboard/src/pages/dashboard/index.tsx"
import { useEffect, useState } from 'react';
...
```typescript filename="src/contexts/TenantContext.tsx"
...
```typescript filename="src/hooks/useDeviceStatus.ts"
import { useEffect, useState } from 'react';
...
```typescript filename="src/components/TradingChart.tsx"
...
```typescript filename="src/lib/cache.ts"
...
```typescript filename="src/hooks/useOptimisticUpdate.ts"
