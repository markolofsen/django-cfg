...
### NowPaymentsConfig Parameters

| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| `api_key` | `str` | *required* | NowPayments API key |
| `ipn_secret` | `str \| None` | `None` | IPN secret for API validation |
| `sandbox` | `bool` | `True` | Use sandbox API (true for testing) |
| `enabled` | `bool` | `False` | Enable/disable NowPayments integration |
