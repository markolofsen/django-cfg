...
**Payment Integration:**
- [**User Management**](../../user-management/overview) - Link with users

### Configuration & Setup

**Getting Started:**
- [**Installation**](/docs/getting-started/installation) - Install Django-CFG with payments
- [**Configuration Guide**](/docs/getting-started/configuration) - Enable payment system
- [**First Project**](/docs/getting-started/first-project) - Quick start tutorial

**Advanced:**
- [**Configuration Models**](/docs/fundamentals/configuration) - PaymentsConfig API reference
- [**Environment Variables**](/docs/fundamentals/configuration/environment) - Secure API key management
- [**Type-Safe Configuration**](/docs/fundamentals/core/type-safety) - Pydantic validation

### Related Features

**User Management:**
- [**User Management Apps**](../../user-management/overview) - Customer integration
- [**Accounts App**](../../user-management/accounts) - User authentication

**Integrations:**
- [**Integrations Overview**](/docs/features/integrations/overview) - All integrations
- [**Built-in Apps**](../../overview) - All production apps
...
- [**Troubleshooting**](/docs/guides/troubleshooting) - Common payment issues

**Production:**
- [**Docker Deployment**](/docs/guides/docker/production) - Deploy payment system
- [**Production Config**](/docs/guides/production-config) - Production payment setup
- [**Logging**](/docs/deployment/logging) - Payment event logging
