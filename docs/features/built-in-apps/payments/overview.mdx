...
### **Next Steps**
👉 **[Configuration Guide](../configuration)** - Set up NowPayments provider

👉 **[Integration Guide](../integration)** - Use models in your Django app
...
**Related Features:**
- **[User Management](../../user-management/overview)** - Customer account integration
- **[Built-in Apps Overview](../../overview)** - All production-ready apps
...
- **[Configuration Models](/docs/fundamentals/configuration)** - Complete payment config API
...
- **[Testing Payments](/docs/cli/commands/payments)** - CLI commands for testing

**API Integration:**
- **[API Generation](/docs/features/api-generation/overview)** - Auto-generate payment API clients
- **[REST API](/docs/features/api-generation/groups)** - Payment API endpoints
