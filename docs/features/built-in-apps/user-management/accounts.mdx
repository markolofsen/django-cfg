...
# Email OTP delivery
# Email delivery configured via EmailConfig
```
...
- [**Environment Variables**](/docs/fundamentals/configuration/environment)** - Secure API key management
- [**Production Config**](/docs/guides/production-config)** - Production auth setup

**Integration:**
- [**Email Module**](/docs/features/modules/email/overview)** - Email OTP delivery
- [**Telegram Module**](/docs/features/modules/telegram/overview)** - Telegram notifications

### Configuration & Setup

**Getting Started:**
- [**Installation**](/docs/getting-started/installation)** - Install Django-CFG with accounts
- [**Configuration Guide**](/docs/getting-started/configuration)** - Enable accounts app
- [**First Project**](/docs/getting-started/first-project)** - Quick start tutorial

**Configuration:**
- [**Configuration Models**](/docs/fundamentals/configuration)** - Accounts config API
- [**Type-Safe Configuration**](/docs/fundamentals/core/type-safety)** - Pydantic patterns
- [**Built-in Apps Overview**](../../overview)** - All production apps

### Tools & Development

**CLI & Management:**
- [**CLI Tools**](/docs/cli/introduction)** - Manage users via CLI
- [**Core Commands**](/docs/cli/commands/core-commands)** - User management commands
- [**Troubleshooting**](/docs/guides/troubleshooting)** - Common auth issues

**Advanced Features:**
- [**AI Agents**](/docs/ai-agents/introduction)** - User-specific AI agents
- [**Background Tasks**](/docs/features/integrations/django-rq/overview)** - Async email sending
