...
description: Auto-generate type-safe TypeScript, Python, Go, and Swift clients from Django REST Framework. Built for Next.js, React, React Native, iOS, and modern Python backends.
---

# API Client Generation

Django-CFG includes **integrated API client generation** that automatically creates type-safe **TypeScript**, **Python**, **Go**, and **Swift** clients from your Django REST Framework API using OpenAPI specifications.
...
✅ **Type-safe API calls** - Full TypeScript/Python/Go/Swift types
...
✅ **Validation** - Zod schemas for runtime validation (TypeScript)
✅ **React integration** - SWR hooks for data fetching
✅ **Pre-generation validation** - validate_openapi command
✅ **Archive system** - Version history for rollback
...
```bash
# Generate all clients (TypeScript, Python, Go, Swift)
python manage.py generate_client
