---
title: CLI Usage
description: Django-CFG management commands for generating type-safe API clients. Command-line interface for creating TypeScript, Python, Go, and Swift client libraries.
---
...
4. Creates TypeScript, Python, Go, and Swift clients for each group
