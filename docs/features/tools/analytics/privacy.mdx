...
| **User id** | FK to your user table | **Only when the visitor is signed in** |
...
This is also the entire point of the feature. It is what hosted analytics cannot do, and it is why `Signed in` appears on your dashboard.
