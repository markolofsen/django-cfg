...
<Cards>
  <Card title="Server-Side Capture" href="/features/modules/django-monitor/server-capture">All automatic hooks and the manual `capture_exception` / `capture_message` API</Card>
  <Card title="Configuration" href="/features/modules/django-monitor/configuration">Slow query threshold, Telegram alerts, retention</Card>
  <Card title="Frontend SDK" href="/features/modules/django-monitor/frontend-sdk">Browser `@djangocfg/monitor` package, `withMonitor`, `window.monitor`</Card>
  <Card title="@djangocfg/layouts" href="/features/modules/django-monitor/layouts-integration">Zero-config monitor + debug panel via `AppLayout`</Card>
  <Card title="Management Commands" href="/features/modules/django-monitor/management-commands">`monitor_status`, `monitor_cleanup`</Card>
  <Card title="Cloudflare D1 Module" href="/features/modules/django-cf">The underlying storage layer</Card>
</Cards>
