...
**Important:** Never set `connection_timeout` on streaming configs. It causes premature stream closure. See [Troubleshooting](./troubleshooting#critical-connection_timeout-bug).
</Callout>
