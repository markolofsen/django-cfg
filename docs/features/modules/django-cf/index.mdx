...
<Cards>
  <Card title="Configuration" href="/features/modules/django-cf/configuration">All `CloudflareConfig` fields and env vars</Card>
  <Card title="D1Q — SQL Factory" href="/features/modules/django-cf/d1-query">How to define tables and generate SQL with `D1Q`</Card>
  <Card title="User Sync" href="/features/modules/django-cf/user-sync">Sync flow, bulk sync, and RQ task details</Card>
  <Card title="Monitor Module" href="/features/modules/django-monitor">Error tracking built on top of `django_cf`</Card>
</Cards>
