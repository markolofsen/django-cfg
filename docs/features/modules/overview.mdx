...
urlpatterns = [
    ...
    path('healthz', SimpleHealthView.as_view(), name='health-simple'),
]
```
...
|--------|-------------|----------|
| [Monitor](/features/modules/django-monitor) | Application performance monitoring | No |
| [Logging](/features/modules/django-logging) | Structured logging | No |
...
| Module | Description | Optional |
|--------|-------------|----------|
| [Payments](/features/modules/django-payments) | Provider-agnostic one-time payments (Stripe-first) with idempotent webhooks, refunds, and reconciliation | Yes (stripe) |
