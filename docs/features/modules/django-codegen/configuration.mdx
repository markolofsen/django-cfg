---
title: Configuration
description: Complete configuration reference for django_generator module.
---

# Configuration

Complete reference for `django_generator` configuration models.
...
```python
from django_cfg.modules.django_generator import Config, OpenAPI, Centrifugo, ORM
...
```python
from django_cfg.modules.django_generator import OpenAPI, Target, ExtensionTarget
...
```python
from django_cfg.modules.django_generator import Target, Language, TargetType
...
```python
from django_cfg.modules.django_generator import ExtensionTarget, Language
...
```python
from django_cfg.modules.django_generator import Language, Platform
...
# {TYPESCRIPT, PYTHON, GO, SWIFT, SWIFT_CODABLE}
...
```python
from django_cfg.modules.django_generator import TargetType
...
```python
from django_cfg.modules.django_generator import ORM, ORMTarget, ORMGenerator
...
```python
from django_cfg.modules.django_generator import GeneratorOptions, Platform
