...
- **Multi-Provider Support** - SMTP, Mailgun, Amazon SES integration
...
class MyConfig(DjangoConfig):
    ...
    email_provider: str = "smtp"  # smtp, mailgun, ses
...
switch_provider('mailgun')

# Send with specific provider
send_email(
    subject="Test Email",
    message="Testing Mailgun integration",
...
- [**Configuration Guide**](/docs/fundamentals/configuration) - Email configuration
- [**Newsletter System**](/docs/features/built-in-apps/user-management/newsletter) - Newsletter integration
- [**Task System**](/docs/features/built-in-apps/operations/tasks) - Background email processing
- [**Template System**](/docs/fundamentals/system/utilities) - Template management
