...
**Advanced:**
- [**Configuration Models**](/docs/configuration) - NgrokConfig API reference
- [**Environment Variables**](/docs/configuration/environment) - Ngrok auth token
- [**Environment Detection**](/docs/configuration/environment) - Dev-only setup
