...
**Configuration:**
- [**Configuration Models**](/docs/configuration) - Complete DjangoConfig reference
- [**Type-Safe Configuration**](/docs/core/type-safety) - Pydantic validation
- [**Environment Variables**](/docs/configuration/environment) - Ngrok auth token and secrets
- [**Environment Detection**](/docs/configuration/environment) - Dev-only ngrok
