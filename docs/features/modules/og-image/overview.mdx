...
- [Presets](/docs/features/modules/og-image/presets) — built-in color schemes and `build_preset()`
- [Layouts](/docs/features/modules/og-image/layouts) — layout presets (DEFAULT, HERO, ARTICLE, MINIMAL)
- [Branding & Icons](/docs/features/modules/og-image/branding) — `get_branded_og_url`, logo, built-in icons
- [Configuration](/docs/features/modules/og-image/configuration) — environment variables
