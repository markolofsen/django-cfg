...
See [Layouts](/docs/features/modules/og-image/layouts) for all available layout presets.
...
- [Layouts](/docs/features/modules/og-image/layouts) — layout presets that control brand position
