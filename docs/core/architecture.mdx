...
- **`third_party.py`** - Unfold, DRF, Constance, Django-CFG API Client Generation
...
- **[Django Integration](./django-integration)** - How Django-CFG integrates with Django
