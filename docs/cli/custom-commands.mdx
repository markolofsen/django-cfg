...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('service', choices=['all', 'telegram'])
...
- [**CLI Introduction**](./introduction) - Overview and installation
- [**Commands Reference**](./commands/overview) - Built-in commands
- [**Configuration Guide**](../../configuration) - Access configuration
