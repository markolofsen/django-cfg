...
**[View Payments →](../payments)** | **[View Maintenance →](../maintenance)**
...
### [🔧 Core Commands](../core-commands) — 8 commands
...
### [🧪 Testing & Monitoring](../testing-monitoring) — 6 commands
...
### [🤖 AI Agents](../ai-agents) — 2 commands
...
### [📚 Knowledge Base](../knowbase) — 2 commands
...
### 📡 Centrifugo / WebSocket — 2 commands
...
| `generate_centrifugo_clients` | Generate type-safe WebSocket RPC clients (Python, TypeScript, Go) |

**[Full Documentation →](/docs/features/integrations/centrifugo/cli-commands)**
...
**[Full Documentation →](/docs/features/integrations/django-rq/overview)**
...
### [🔧 Maintenance Mode](../maintenance) — 3 commands
...
| Manage payments | **[Payments](../payments)** |
| Use AI agents | **[AI Agents](../ai-agents)** |
| Configure maintenance | **[Maintenance](../maintenance)** |
