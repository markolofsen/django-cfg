...
|--------|------|-------------|
| `--cloudflare` | `flag` | Sync with Cloudflare |
...
| Option | Type | Description |
|--------|------|-------------|
| `--enable` | `flag` | Enable Cloudflare maintenance |
| `--disable` | `flag` | Disable Cloudflare maintenance |
...
- Use `--cloudflare` to sync with CDN, not just Django
- Test maintenance page appearance before scheduled downtime
- Schedule during low traffic (e.g., 2-4 AM)

## See Also

- [Quick Reference](../quick-reference)
- [Maintenance App Guide](/docs/features/built-in-apps/operations/maintenance)
