...
poetry run python manage.py check_settings --verbose
...
- `check_settings` - Configuration validation and diagnostics
...
### Core Commands
- **[Core Commands](./commands/core-commands)** - Essential project management commands (info, create-project, check-settings)
- **[Development Commands](./commands/development)** - Development server, migrations, debugging tools
- **[Custom Commands](./custom-commands)** - Create your own management commands

### Feature-Specific Commands
- **[Background Task Commands](/features/modules/django-rq)** - Manage Django-RQ workers and tasks

### Guides & Configuration
- **[Configuration Guide](../../configuration)** - Configure CLI behavior and defaults
...
**Core Commands:**
- **[Core Commands](./commands/core-commands)** - Essential project management commands
- **[Development Commands](./commands/development)** - Development server and debugging tools
- **[Custom Commands](./custom-commands)** - Create your own management commands
- **[Quick Reference](./commands/quick-reference)** - Command cheat sheet

**Feature Commands:**
- **[Background Task Commands](/features/modules/django-rq)** - Manage Django-RQ workers
...
**Configuration:**
- **[Configuration Models](../../configuration)** - All configuration options
- **[Type-Safe Configuration](../../core/type-safety)** - Pydantic patterns
- **[Environment Detection](../../configuration/environment)** - Multi-environment setup
- **[Environment Variables](../../configuration/environment)** - Secrets management

### Features & Deployment

**Built-in Apps:**
- **[Built-in Apps Overview](../../features/built-in-apps/overview)** - All available apps
- **[User Management](/features/built-in-apps/user-management)** - Accounts and support
