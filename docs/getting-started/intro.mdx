...
Your `DjangoConfig` can be even simpler with the new **modular extensions system**! Instead of configuring everything in one file, extensions like payments, leads, and support now configure themselves automatically.
...
[Learn about Extensions →](/docs/extensions) | [Migration Guide →](/docs/extensions/migration-guide)
</Callout>
