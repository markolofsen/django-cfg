...
class CfgCentrifugoAdminApiAPI:
    ...
    async def centrifugo_server_channels_create(
        self,
        data: CentrifugoChannelsRequestRequest,
    ) -> CentrifugoChannelsResponse:
        """
    ...
    async def centrifugo_server_history_create(
        self,
        data: CentrifugoHistoryRequestRequest,
    ) -> CentrifugoHistoryResponse:
        """
        Get channel history
    ...
    async def centrifugo_server_presence_create(
        self,
        data: CentrifugoPresenceRequestRequest,
    ) -> CentrifugoPresenceResponse:
        """
    ...
    async def centrifugo_server_presence_stats_create(
        self,
        data: CentrifugoPresenceStatsRequestRequest,
    ) -> CentrifugoPresenceStatsResponse:
        """
