...
class CfgRqRegistriesAPI:
    ...
    async def rq_jobs_registries_deferred_list(
        self,
    ...
    async def rq_jobs_registries_failed_list(
        self,
        ordering: str | None = None,
        page: int | None = None,
        page_size: int | None = None,
    ...
    async def rq_jobs_registries_failed_clear_create(
        self,
        data: JobListRequest,
        queue: str,
    ) -> JobActionResponse:
    ...
    async def rq_jobs_registries_failed_requeue_all_create(
        self,
        data: JobListRequest,
        queue: str,
    ) -> JobActionResponse:
    ...
    async def rq_jobs_registries_finished_list(
        self,
        ordering: str | None = None,
        page: int | None = None,
        page_size: int | None = None,
    ...
    async def rq_jobs_registries_finished_clear_create(
        self,
        data: JobListRequest,
        queue: str,
    ) -> JobActionResponse:
    ...
    async def rq_jobs_registries_started_list(
        self,
        ordering: str | None = None,
        page: int | None = None,
        page_size: int | None = None,
