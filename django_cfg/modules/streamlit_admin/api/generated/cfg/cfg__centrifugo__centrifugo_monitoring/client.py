...
class CfgCentrifugoMonitoringAPI:
    ...
    async def centrifugo_monitor_channels_retrieve(
        self,
        hours: int | None = None,
    ) -> list[ChannelList]:
        """
    ...
    async def centrifugo_monitor_health_retrieve(self) -> CentrifugoHealthCheck:
        """
    ...
    async def centrifugo_monitor_overview_retrieve(
        self,
        hours: int | None = None,
    ) -> CentrifugoOverviewStats:
        """
    ...
    async def centrifugo_monitor_publishes_list(
        self,
    ...
    async def centrifugo_monitor_timeline_retrieve(
        self,
        hours: int | None = None,
