...
from ..registry.pricing import calculate_chat_cost
from ..core.types import ChatChoice, ChatCompletionResponse, TokenUsage
from ..structured.response_format import wants_json
...
class ResponseBuilder:
    ...
    def build_chat_response(
        ...
        extracted_json = None
        if wants_json(response_format) and content and self.json_extractor:
            try:
