"""
LLM Client for modules.django_llm.
...
from ..registry.models_api import ModelsQueryAPI
...
class LLMClient(BaseCfgModule):
    ...
    def __init__(
        ...
        Args:
            ...
            config: optional host config object for headers and settings (see modules.django_llm.config)
    ...
    def chat_completion(
        ...
        **kwargs
        ...
        Args:
            ...
            response_format: Output format — one of:
                - ``"json_object"`` — plain JSON mode (syntax only)
                - a ready API ``dict`` — passed through unchanged
    ...
    def estimate_cost(self, model: str, input_tokens: int, output_tokens: int) -> float:
        ...
        """
        from ..registry.pricing import estimate_cost
