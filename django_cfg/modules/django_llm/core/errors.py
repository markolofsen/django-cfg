"""
Typed error taxonomy for django_cfg.modules.django_llm.
...
class LLMError(Exception):
    """Base for every django_cfg.modules.django_llm failure.
...
def classify_exception(
    ...
    *,
    ...
    """Map any exception to the django_cfg.modules.django_llm taxonomy.
