...
from .models import ModelsCache, OpenRouterModel
...
class ModelsQueryAPI:
    ...
    def get_model_info(self, model_id: str) -> Optional[OpenRouterModel]:
        ...
        Returns:
            OpenRouterModel or None if not found
        """
        if not self.models_cache:
            return None
    ...
    def get_budget_models(self, max_price: float = 1.0) -> List[OpenRouterModel]:
        ...
        Returns:
            List of budget OpenRouterModel objects
        """
        if not self.models_cache:
            return []
    ...
    def get_premium_models(self, min_price: float = 10.0) -> List[OpenRouterModel]:
        ...
        Returns:
            List of premium OpenRouterModel objects
        """
        if not self.models_cache:
            return []
