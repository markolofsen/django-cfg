...
class OpenAPI(BaseModel):
    ...
    # Source-of-truth root inside the Django project. When set, every
    # TS/Python/Go target is generated into `source_root/<target-name>/`
    # first, then copied to its `path` (the consumer location).
