"""Storage adapter template (static).

Mirrors the legacy `storage.ts` API surface so consumers can swap
LocalStorage / Cookie / Memory backends without touching call sites.
"""
