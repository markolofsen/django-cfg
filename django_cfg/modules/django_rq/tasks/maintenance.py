...
def cleanup_orphaned_job_keys(
    ...
    Example:
        >>> from django_cfg.modules.django_rq.tasks.maintenance import cleanup_orphaned_job_keys
...
def get_rq_stats(queue_name: str = "default") -> Dict[str, any]:
    ...
    Example:
        >>> from django_cfg.modules.django_rq.tasks.maintenance import get_rq_stats
        >>> stats = get_rq_stats()
...
def diagnose_scheduled_jobs(queue_name: str = "default") -> Dict[str, any]:
    ...
    Example:
        >>> from django_cfg.modules.django_rq.tasks.maintenance import diagnose_scheduled_jobs
