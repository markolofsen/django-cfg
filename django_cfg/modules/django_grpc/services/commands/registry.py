...
Usage:
    ...
    from django_cfg.modules.django_grpc.commands.registry import register_streaming_service
    ...
    from django_cfg.modules.django_grpc.commands.registry import get_streaming_service
