...
Usage:
    from django_cfg.modules.django_grpc.services.commands.viewset_mixin import (
...
class StreamingCommandViewSetMixin:
    ...
    def exec_sync_command(
        ...
        **kwargs
        ...
        from django_cfg.modules.django_grpc.services.commands.base import (
        ...
        async def _exec():
            try:
                ...
                from django_cfg.modules.django_grpc.services.commands.registry import get_streaming_service
