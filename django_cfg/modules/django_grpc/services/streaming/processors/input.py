    ...
    async def _process_async_for(
        ...
        try:
            ...
            async for message in request_iterator:
                # G-4 fix: stop processing messages for dead clients.
                # Without this guard, a disconnected client (no RST_STREAM) keeps
                # triggering process_message (DB queries, etc.) until the keepalive
                # timeout fires.  Re-checked after process_message too.
                ...
                # G-4 fix: post-process check — context may have been cancelled
                # while process_message was awaiting a DB query or external call.
                if context.cancelled():
                    break
