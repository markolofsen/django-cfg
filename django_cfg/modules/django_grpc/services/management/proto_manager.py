...
from .config_helper import get_grpc_module_config
...
class ProtoFilesManager:
    ...
    def __init__(self):
        ...
        self.grpc_config = get_grpc_module_config()
    ...
    def get_proto_dir(self) -> Path:
        ...
        """
        # DjangoGrpcModuleConfig has no proto.output_dir field — always use MEDIA_ROOT/protos
        from django_cfg.core.utils.paths import get_media_path
        return get_media_path("protos")
