...
class DynamicGRPCClient:
    ...
    def __init__(
        ...
        config: ClientChannelConfig | None = None,
        ...
        try:
            ...
            self._file_descriptor_cache: Dict[str, tuple[list[descriptor_pb2.FileDescriptorProto], descriptor_pb2.FileDescriptorProto]] = {}
    ...
    def _get_file_descriptors(self, service_name: str) -> tuple[list[descriptor_pb2.FileDescriptorProto], descriptor_pb2.FileDescriptorProto]:
        """
    ...
    def _find_method_descriptor(
        self,
        service_descriptor: descriptor_pb2.ServiceDescriptorProto,
        method_name: str,
    ) -> descriptor_pb2.MethodDescriptorProto | None:
        """
