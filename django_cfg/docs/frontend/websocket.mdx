...
<Callout type="info">
For Django-side Channels setup see [Django Runtime — Channels & ASGI](../guides/django-runtime/channels-asgi). For the generated API layer see [Data Layer](./data-layer).
</Callout>
