...
```python filename="api/environment/loader.py"
...
```python filename="PostgreSQL URL Examples"
# Basic connection
...
```python filename="MySQL URL Examples"
...
```python filename="SQLite URL Examples"
...
```python filename="Other Database Backends"
# Oracle
...
- [**Migrations**](./migrations) - Migration commands and auto-fix
- [**Testing**](./testing) - Zero-config test database management
- [**Cross-Database Relations**](./cross-database-relations) - ForeignKeys across databases

## See Also

- [**Multi-Database Guide**](/docs/guides/multi-database) - Complete multi-database setup
