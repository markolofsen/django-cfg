...
- ✅ [Type-safe loader](../../core/type-safety) with Pydantic models
...
class EnvironmentConfig(BaseSettings):
    ...
    # Admin Configuration
    # Email addresses for system notifications (email + Telegram)
    # Used for: LLM balance alerts, error notifications, system alerts
...
# === Admin Notifications ===
ADMIN_EMAILS=["admin@myapp.com","devops@myapp.com","alerts@myapp.com"]
...
```bash filename="environment/.env.example"
...
```bash filename="Development Mode"
...
```bash filename=".env (INSECURE - committed to git)"
...
- [Environment Management](../../configuration/environment) - Detailed environment guide
