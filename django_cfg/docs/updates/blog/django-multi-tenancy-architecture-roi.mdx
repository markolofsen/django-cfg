...
[Get Started](/docs/getting-started/intro) | [Architecture Guide](/docs/core/architecture)
</Callout>
...
- **[Core Architecture Documentation](/docs/core/architecture)** - Deep dive into Django-CFG architectural patterns
