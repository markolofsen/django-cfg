...
[Get Started](/docs/core/architecture) | [Deployment Guide](/docs/guides/docker/production)
</Callout>
...
- **[Django-CFG Architecture Guide](/docs/core/architecture)** - Understand core architecture patterns
