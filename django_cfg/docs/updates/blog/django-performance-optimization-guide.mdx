...
Django-CFG doesn't just automate configuration - it learns from your application patterns and recommends optimizations specific to your workload.
</Callout>
...
[Get Started](/core/architecture) | [Deployment Guide](/guides/docker/production)
</Callout>

**Related Blog Post**: Learn how AI automation eliminates configuration complexity in our [Django Configuration Debt Analysis](./django-configuration-debt-analysis).

---

## Related Resources

- **[Django-CFG Architecture Guide](/core/architecture)** - Understand core architecture patterns
- **[Production Docker Deployment](/guides/docker/production)** - Deploy optimized Django apps with Docker
- **[Configuration Debt Analysis](./django-configuration-debt-analysis)** - Learn about Django setup cost savings
- **[Environment Setup Guide](/deployment/environment-setup)** - Configure production environments correctly
- **[Django Testing Best Practices](/deployment/monitoring)** - Ensure performance optimizations don't break functionality
