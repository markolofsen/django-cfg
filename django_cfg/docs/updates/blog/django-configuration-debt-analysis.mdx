...
[Get Started](/getting-started/intro) | [See Live Demo](/getting-started/first-project)
</Callout>
...
- **[Getting Started Guide](/getting-started/intro)** - Install Django-CFG and create your first project
- **[Configuration Guide](/configuration)** - Master Django-CFG configuration
- **[Production Deployment](/guides/docker/production)** - Deploy to production with Docker
- **[Environment Setup](/deployment/environment-setup)** - Configure production environments
...
**Want to dive deeper?** Check out our [First Project Guide](/getting-started/first-project).
