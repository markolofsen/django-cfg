...
OTP services are implemented at the project level. The example below shows a typical service pattern:

```python
# apps/accounts/services.py (project-level implementation)
...
```python
from apps.accounts.models import RegistrationSource, UserRegistrationSource
...
from apps.accounts.services import OTPService  # project-level service
...
class AuthenticationTest(TestCase):
    ...
    def test_otp_verification(self):
        ...
        from apps.accounts.models import OTPSecret
