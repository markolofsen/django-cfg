...
### Configuration
- **[Database Configuration](/configuration/database)** - PostgreSQL setup
- **[Cache Configuration](/configuration/cache)** - Redis caching
- **[Environment Detection](/configuration/environment)** - Multi-environment
...
- **[Centrifugo WebSocket RPC](/features/modules/django-centrifugo/)** - Real-time communication
...
- **Bugs?** Report on [GitHub](https://github.com/markolofsen/django-cfg/issues)
