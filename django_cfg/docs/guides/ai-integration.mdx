...
**LLM Module:**
- [**LLM Module Overview**](../../features/modules/django-llm/overview) - Multi-provider LLM integration

**MCP / AI Agent Integration:**
- [**AI MCP Getting Started**](./ai-mcp) - Connect AI agents via Model Context Protocol
- [**MCP Module Docs**](../../features/modules/django-mcp/architecture) - Full django_mcp module reference
...
**Advanced Configuration:**
- [**Environment Variables**](../../configuration/environment) - Secure API key management
- [**Environment Detection**](../../configuration/environment) - Environment-based AI config
- [**Type-Safe Configuration**](../../core/type-safety) - AI config validation

### Background Processing & Tools

**Task Processing:**
- [**ReArq Integration**](../../features/modules/django-rq/overview) - Async AI processing
...
- [**Docker Deployment**](./docker/production) - Deploy AI features
