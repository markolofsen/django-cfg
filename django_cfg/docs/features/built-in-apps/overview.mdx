...
These are [Extensions](/extensions) that come **pre-installed** in the Django-CFG solution template. They're fully functional, customizable Django apps ready to use out of the box.
</Callout>

Django-CFG solution template includes production-ready extensions that use the modern [Extensions System](/extensions) with auto-discovery and type-safe [Pydantic configuration](/core/type-safety).
...
[Learn more about Extensions System →](/extensions)
...
[**Explore User Management →**](/features/built-in-apps/user-management)
...
- **Rate Limiting** - API rate limiting (see [Rate Limiting](/core/rate-limiting))
...
- [Backend Extensions](/extensions/backend-extensions) - Creating extensions
- [Frontend Extensions](/extensions/frontend-extensions) - React/TypeScript extensions
- [Migration Guide](/extensions/migration-guide) - Migrating from legacy apps
...
Browse and install additional extensions from the [django-cfg repository](https://github.com/markolofsen/django-cfg)
