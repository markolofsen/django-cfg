...
- **[@action Request Body Validation](./drf-action-request-body)** — Strict rule that blocks client generation when detail-actions silently inherit the ViewSet's default request body
