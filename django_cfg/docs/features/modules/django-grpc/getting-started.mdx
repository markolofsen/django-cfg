...
# config = ClientChannelConfig(address="localhost:50051", call_timeout=10.0)
...
1. **[Concepts](./concepts)** - Understand architecture and patterns
2. **[Authentication](./authentication)** - Deep dive into API keys
3. **[Configuration](./configuration)** - Explore all config options
4. **[Dynamic Invocation](./dynamic-invocation)** - Test without proto files
5. **[FAQ](./faq)** - Common questions and solutions
