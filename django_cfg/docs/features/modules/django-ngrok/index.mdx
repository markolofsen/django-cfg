...
When you develop integration with external services (Stripe, Telegram, etc.), these services send webhooks to your server. But your local `localhost:8000` is not accessible from the internet!
...
def create_payment(request):
    ...
    # Pass to Stripe/payment providers
...
- **[Webhook Examples](./webhook-examples)** - Integration with Stripe, Telegram
...
- **[Integrations Overview](/features/modules/django-ngrok)** - All available integrations

**Advanced Configuration:**
- **[Type-Safe Configuration](/core/type-safety)** - Ngrok config with Pydantic
- **[Environment Variables](/configuration/environment)** - Ngrok auth token setup
...
- **[Django-RQ Integration](/features/modules/django-rq)** - Process webhooks asynchronously
