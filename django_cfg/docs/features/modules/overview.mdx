...
### Currency & Finance
- **[Currency Overview](../modules/currency/overview)** - Multi-currency conversion with crypto support
- **[Currency Quick Start](./currency/quick-start)** - Get started in 5 minutes
- **[Database Integration](../modules/currency/overview)** - ORM integration guide

### Communication
- **[Email Overview](../modules/email/overview)** - Advanced email system
- **[Telegram Overview](../modules/telegram/overview)** - Bot integration and notifications
...
**Available Modules:**
- **[Currency Module](../modules/currency/overview)** - Multi-currency conversion with 14K+ currencies
- **[Email Module](../modules/email/overview)** - Production email service integration
- **[Telegram Module](../modules/telegram/overview)** - Telegram bot and notifications
