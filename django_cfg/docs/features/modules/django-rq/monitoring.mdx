...
POST /api/cfg/rq/jobs/{id}/cancel/  - Cancel job (cooperative cancellation)
POST /api/cfg/rq/jobs/{id}/cancel/?force=true - Force stop (kills worker)
POST /api/cfg/rq/jobs/{id}/requeue/ - Requeue job
DELETE /api/cfg/rq/jobs/{id}/       - Delete job

GET  /api/cfg/rq/jobs/registries/failed/     - List failed jobs
GET  /api/cfg/rq/jobs/registries/finished/   - List finished jobs
GET  /api/cfg/rq/jobs/registries/deferred/   - List deferred jobs
GET  /api/cfg/rq/jobs/registries/started/    - List running jobs
POST /api/cfg/rq/jobs/registries/failed/requeue-all/?queue=default - Requeue all failed
POST /api/cfg/rq/jobs/registries/failed/clear/?queue=default       - Clear failed registry
POST /api/cfg/rq/jobs/registries/finished/clear/?queue=default     - Clear finished registry
...
### Documentation
- [Overview](/features/modules/django-rq) - Introduction
- [Configuration](./configuration) - Setup
- [Examples](./examples) - Code examples
- [Job Cancellation](./job-cancellation) - Cooperative cancellation for long-running jobs
