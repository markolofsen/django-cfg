...
<Cards>
  <Card title="Configuration" href="/features/modules/django-migrator/configuration">MigratorOptions, DATABASE_ROUTING_RULES, and routing setup.</Card>
  <Card title="Drift Detection" href="/features/modules/django-migrator/drift-detection">How DriftDetector classifies incidents and what each drift type means.</Card>
  <Card title="Auto-Repair" href="/features/modules/django-migrator/auto-repair">RepairEngine, fake-apply, fake-rewind, and companion-field handling.</Card>
</Cards>
