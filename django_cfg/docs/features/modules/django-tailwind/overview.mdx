...
<Callout type="info">
This module supplies layout templates for standard Django server-rendered views. If you are looking for the DRF Browsable API theme, see [DRF Theme](../django-drf-theme/overview).
</Callout>
...
- [DRF Theme](../django-drf-theme/overview) — Tailwind-styled DRF Browsable API renderer
