...
See [Test Database Command](/cli/commands/testing-monitoring#test_db) for detailed documentation.
...
- [**Test Database Command**](/cli/commands/testing-monitoring#test_db) - Manual database management
