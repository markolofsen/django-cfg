...
**Learn more:** [Backend Extensions Guide](./backend-extensions)
...
**Learn more:** [Frontend Extensions Guide](./frontend-extensions)
...
<Cards>
  <Cards.Card title="Backend Extensions" href="/extensions/backend-extensions" />
  ...
  <Cards.Card title="API Reference" href="/extensions/api-reference" />
</Cards>
...
Browse available extensions in the [the django-cfg repo](https://github.com/markolofsen/django-cfg) or create your own!
...
Check out the [Backend Extensions Guide](./backend-extensions) for a step-by-step tutorial!
</Callout>
