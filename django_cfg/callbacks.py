...
def environment_callback(request: HttpRequest) -> Dict[str, Any]:
    ...
    return {
        ...
        "database": {
            "engine": toolkit._database_config.engine if hasattr(toolkit, '_database_config') else "Unknown",
            "name": toolkit._database_config.name if hasattr(toolkit, '_database_config') else "Unknown",
        },
        "cache": {
            "backend": toolkit._cache_config.backend if hasattr(toolkit, '_cache_config') else "default",
        },
        "features": {
